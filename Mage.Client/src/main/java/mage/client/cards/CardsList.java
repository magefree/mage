 ...
 public class CardsList extends javax.swing.JPanel implements MouseListener, ICardGrid {
    ...
    private void initComponents() {
        ...
        lblCount.setText(java.text.MessageFormat.format(java.util.ResourceBundle.getBundle("SwingMessage").getString("CardsList.lblCount.text"), new Object[] {})); // NOI18N
        lblCount.setToolTipText(java.text.MessageFormat.format(java.util.ResourceBundle.getBundle("SwingMessage").getString("CardsList.lblCount.toolTipText_1"), new Object[] {})); // NOI18N
        ...
        lblLandCount.setText(java.text.MessageFormat.format(java.util.ResourceBundle.getBundle("SwingMessage").getString("CardsList.lblLandCount.text"), new Object[] {})); // NOI18N
        lblLandCount.setToolTipText(java.text.MessageFormat.format(java.util.ResourceBundle.getBundle("SwingMessage").getString("CardsList.lblLandCount.toolTipText"), new Object[] {})); // NOI18N
        ...
        lblCreatureCount.setText(java.text.MessageFormat.format(java.util.ResourceBundle.getBundle("SwingMessage").getString("CardsList.lblCreatureCount.text"), new Object[] {})); // NOI18N
        lblCreatureCount.setToolTipText(java.text.MessageFormat.format(java.util.ResourceBundle.getBundle("SwingMessage").getString("CardsList.lblCreatureCount.toolTipText"), new Object[] {})); // NOI18N
        ...
        chkPiles.setText(java.text.MessageFormat.format(java.util.ResourceBundle.getBundle("SwingMessage").getString("CardsList.chkPiles.text"), new Object[] {})); // NOI18N
        ...
        cbSortBy.setToolTipText(java.text.MessageFormat.format(java.util.ResourceBundle.getBundle("SwingMessage").getString("CardsList.cbSortBy.toolTipText"), new Object[] {})); // NOI18N
        ...
        jToggleListView.setToolTipText(java.text.MessageFormat.format(java.util.ResourceBundle.getBundle("SwingMessage").getString("CardsList.jToggleListView.toolTipText"), new Object[] {})); // NOI18N
        ...
        jToggleCardView.setToolTipText(java.text.MessageFormat.format(java.util.ResourceBundle.getBundle("SwingMessage").getString("CardsList.jToggleCardView.toolTipText"), new Object[] {})); // NOI18N
        ...
        jToggleListView.getAccessibleContext().setAccessibleDescription(java.text.MessageFormat.format(java.util.ResourceBundle.getBundle("SwingMessage").getString("CardsList.jToggleListView.AccessibleContext.accessibleDescription"), new Object[] {})); // NOI18N
