...
public class PlayerPanelExt extends javax.swing.JPanel {
    ...
    private Color inactiveBackgroundColor = new Color(200, 200, 180, 200);
    private Color activeBackgroundColor = new Color(200, 255, 200, 200);
    private Color deadBackgroundColor = new Color(131, 94, 83, 200);
