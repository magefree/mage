...
public final class Constants {
    ...
    public static final int AUTO_CHOOSE_TARGET_DISABLE      = 0;
    public static final int AUTO_CHOOSE_TARGET_NON_FEEL_BAD = 1;
    public static final int AUTO_CHOOSE_TARGET_ALL          = 2;
