...
public class TablesPanel extends javax.swing.JPanel {
    ...
    TableCellRenderer skillCellRenderer = new DefaultTableCellRenderer() {
        ...
        private final ImageIcon skillIcon = new ImageIcon(ThemeManager.getCurrentTheme().getResource("/info/yellow_star_16.png"));
    ...
    private void setGUISize() {
        ...
        ImageIcon icon = new javax.swing.ImageIcon(ThemeManager.getCurrentTheme().getResource("/buttons/state_waiting.png"));
        ...
        icon = new javax.swing.ImageIcon(ThemeManager.getCurrentTheme().getResource("/buttons/state_active.png"));
        img = icon.getImage();
        ...
        icon = new javax.swing.ImageIcon(ThemeManager.getCurrentTheme().getResource("/buttons/state_finished.png"));
        img = icon.getImage();
        newimg = img.getScaledInstance(GUISizeHelper.menuFont.getSize(), GUISizeHelper.menuFont.getSize(), java.awt.Image.SCALE_SMOOTH);
        btnStateFinished.setIcon(new ImageIcon(newimg));

        int iconSize = 48 + GUISizeHelper.menuFont.getSize() * 2 - 15;
        icon = new javax.swing.ImageIcon(ThemeManager.getCurrentTheme().getResource("/buttons/match_new.png"));
        img = icon.getImage();
        newimg = img.getScaledInstance(iconSize, iconSize, java.awt.Image.SCALE_SMOOTH);
        btnNewTable.setIcon(new ImageIcon(newimg));

        icon = new javax.swing.ImageIcon(ThemeManager.getCurrentTheme().getResource("/buttons/tourney_new.png"));
        img = icon.getImage();
        newimg = img.getScaledInstance(iconSize, iconSize, java.awt.Image.SCALE_SMOOTH);
    ...
    private void initComponents() {
        ...
        btnNewTable.setIcon(new javax.swing.ImageIcon(ThemeManager.getCurrentTheme().getResource("/buttons/match_new.png"))); // NOI18N
        ...
        btnNewTournament.setIcon(new javax.swing.ImageIcon(ThemeManager.getCurrentTheme().getResource("/buttons/tourney_new.png"))); // NOI18N
