    ...
    private static final Set<String> supportedSets = new ArraySet<String>() {
        {
            ...
            add("P15A"); // Fifteenth Anniversary Cards
            add("SHM"); // Shadowmoor
            ...
            add("PC2"); // Planechase 2012 Edition
            ...
            add("THS"); // Theros
            add("C13"); // Commander 2013 Edition
            ...
            add("C14"); // Commander 2014 Edition
            ...
            add("C15"); // Commander 2015 Edition
            ...
            add("C16"); // Commander 2016 Edition
            ...
            add("C17"); // Commander 2017 Edition
            add("WMC"); // World Magic Cup Qualifiers
            add("H17"); // HASCON Promo 2017
            add("PHTR"); // Heroes Of The Realm 2016
            add("PXLN"); // Ixalan Promos
            add("XLN"); // Ixalan
            add("PSS2"); // Ixalan Standard Showdown
            add("G17"); // Gift Pack 2017
            add("DDT"); // Duel Decks: Merfolk Vs. Goblins
            add("PUST"); // Unstable Promos
            add("IMA"); // Iconic Masters
            add("V17"); // From The Vault: Transform
            add("PXTC"); // Ixalan Treasure Chest
            ...
            add("GS1"); // Global Series Jiang Yanggu And Mu Yanling
            ...
            add("JMP"); // Jumpstart
            add("PH19"); // Heroes Of The Realm 2019
            ...
            add("UNF"); // Unfinity
            add("GN3"); // Game Night FreeForAll // 2022
