...
public class VintageCubeDecember2020 extends DraftCube {

    public VintageCubeDecember2020() {
        super("MTGO Vintage Cube December 2020");
        ...
        cubeCards.add(new CardIdentity("Felidar Retreat", ""));
        ...
        cubeCards.add(new CardIdentity("Nullpriest of Oblivion", ""));
        cubeCards.add(new CardIdentity("Woe Strider", ""));
        cubeCards.add(new CardIdentity("Nighthawk Scavenger", ""));
        cubeCards.add(new CardIdentity("Sling-Gang Lieutenant", ""));
        ...
        cubeCards.add(new CardIdentity("Earthshaker Khenra", ""));
        ...
        cubeCards.add(new CardIdentity("Krark, the Thumbless", ""));
