...
public class VintageCubeOctober2023 extends DraftCube {

    public VintageCubeOctober2023() {
        super("MTGO Vintage Cube October 2023");
        ...
        cubeCards.add(new CardIdentity("Boon-Bringer Valkyrie", ""));
        ...
        cubeCards.add(new CardIdentity("Svyelun of Sea and Sky", ""));
        ...
        cubeCards.add(new CardIdentity("Seal of Removal", ""));
        ...
        cubeCards.add(new CardIdentity("Jadar, Ghoulcaller of Nephalia", ""));
        cubeCards.add(new CardIdentity("Kitesail Freebooter", ""));
        cubeCards.add(new CardIdentity("Misery's Shadow", ""));
        ...
        cubeCards.add(new CardIdentity("Call of the Ring", ""));
        ...
        cubeCards.add(new CardIdentity("Rabbit Battery", ""));
        ...
        cubeCards.add(new CardIdentity("Squee, Dubious Monarch", ""));
        ...
        cubeCards.add(new CardIdentity("Nahiri's Warcrafting", ""));
        ...
        cubeCards.add(new CardIdentity("Kumano Faces Kakkazan", ""));
        cubeCards.add(new CardIdentity("Bitter Reunion", ""));
        ...
        cubeCards.add(new CardIdentity("Deeproot Wayfinder", ""));
        ...
        cubeCards.add(new CardIdentity("Thrun, Breaker of Silence", ""));
        cubeCards.add(new CardIdentity("Titania, Protector of Argoth", ""));
        cubeCards.add(new CardIdentity("Workshop Warchief", ""));
        ...
        cubeCards.add(new CardIdentity("Titan of Industry", ""));
        ...
        cubeCards.add(new CardIdentity("Wrenn and Realmbreaker", ""));
        ...
        cubeCards.add(new CardIdentity("Invasion of Ikoria", ""));
        cubeCards.add(new CardIdentity("Talisman of Progress", ""));
        cubeCards.add(new CardIdentity("Soulherder", ""));
        cubeCards.add(new CardIdentity("Teferi, Time Raveler", ""));
        cubeCards.add(new CardIdentity("Urza, Lord Protector", ""));
        ...
        cubeCards.add(new CardIdentity("Rona, Herald of Invasion", ""));
        ...
        cubeCards.add(new CardIdentity("Kogla and Yidaro", ""));
        ...
        cubeCards.add(new CardIdentity("Sigarda, Font of Blessings", ""));
        cubeCards.add(new CardIdentity("Damn", ""));
        cubeCards.add(new CardIdentity("Talisman of Hierarchy", ""));
        ...
        cubeCards.add(new CardIdentity("Talisman of Resilience", ""));
        ...
        cubeCards.add(new CardIdentity("Inspired Ultimatum", ""));
        ...
        cubeCards.add(new CardIdentity("Kenrith, the Returned King", ""));
