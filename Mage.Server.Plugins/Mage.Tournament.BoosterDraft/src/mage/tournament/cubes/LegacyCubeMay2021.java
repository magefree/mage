 ...
 * @author JayDi85
 */
public class LegacyCubeMay2021 extends DraftCube {

    public LegacyCubeMay2021() {
        super("MTGO Legacy Cube May 2021");
        ...
        cubeCards.add(new CardIdentity("Archon of Coronation", ""));
        ...
        cubeCards.add(new CardIdentity("Clarion Spirit", ""));
        ...
        cubeCards.add(new CardIdentity("Fall from Favor", ""));
        ...
        cubeCards.add(new CardIdentity("Ghost Quarter", ""));
        ...
        cubeCards.add(new CardIdentity("Glorious Protector", ""));
        ...
        cubeCards.add(new CardIdentity("Jace, Mirror Mage", ""));
        ...
        cubeCards.add(new CardIdentity("Kazandu Mammoth", ""));
        ...
        cubeCards.add(new CardIdentity("Magmatic Channeler", ""));
        ...
        cubeCards.add(new CardIdentity("Maul of the Skyclaves", ""));
        ...
        cubeCards.add(new CardIdentity("Obosh, the Preypiercer", ""));
        ...
        cubeCards.add(new CardIdentity("Plargg, Dean of Chaos", ""));
        ...
        cubeCards.add(new CardIdentity("Primal Might", ""));
        ...
        cubeCards.add(new CardIdentity("Reidane, God of the Worthy", ""));
        ...
        cubeCards.add(new CardIdentity("Slash the Ranks", ""));
        ...
        cubeCards.add(new CardIdentity("Starnheim Unleashed", ""));
        ...
        cubeCards.add(new CardIdentity("Vivien, Monsters' Advocate", ""));
