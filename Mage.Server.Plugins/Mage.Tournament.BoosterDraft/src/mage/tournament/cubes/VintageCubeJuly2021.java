...
public class VintageCubeJuly2021 extends DraftCube {

    public VintageCubeJuly2021() {
        super("MTGO Vintage Cube July 2021");
        ...
        cubeCards.add(new CardIdentity("Agadeem's Awakening", ""));
        ...
        cubeCards.add(new CardIdentity("Commit // Memory", ""));
        ...
        cubeCards.add(new CardIdentity("Ebondeath, Dracolich", ""));
        cubeCards.add(new CardIdentity("Eidolon of Obstruction", ""));
        ...
        cubeCards.add(new CardIdentity("Flame Spill", ""));
        cubeCards.add(new CardIdentity("Flametongue Yearling", ""));
        ...
        cubeCards.add(new CardIdentity("Master of Death", ""));
        ...
        cubeCards.add(new CardIdentity("Opposition Agent", ""));
        ...
        cubeCards.add(new CardIdentity("Sanctum Prelate", ""));
        ...
        cubeCards.add(new CardIdentity("Seasoned Hallowblade", ""));
        ...
        cubeCards.add(new CardIdentity("Shatterskull Smashing", ""));
        ...
        cubeCards.add(new CardIdentity("The Blackstaff of Waterdeep", ""));
        ...
        cubeCards.add(new CardIdentity("Vorinclex, Monstrous Raider", ""));
