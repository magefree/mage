...
public class SmoothedLondonMulliganTest extends MulliganTestBase {
    ...
    @Test
    public void testSmoothedLondonMulligan_NoMulligan() {
        MulliganScenarioTest scenario = new MulliganScenarioTest(MulliganType.SMOOTHED_LONDON, 0);
    ...
    @Test
    public void testSmoothedLondonMulligan_OneMulligan() {
        MulliganScenarioTest scenario = new MulliganScenarioTest(MulliganType.SMOOTHED_LONDON, 0);
        Set<UUID> hand1 = new HashSet<>();
    ...
    @Test
    public void testSmoothedLondonMulligan_TwoMulligan() {
        MulliganScenarioTest scenario = new MulliganScenarioTest(MulliganType.SMOOTHED_LONDON, 0);
        Set<UUID> hand1 = new HashSet<>();
        Set<UUID> hand2 = new HashSet<>();
    ...
    @Test
    public void testSmoothedLondonMulligan_FreeMulligan_NoMulligan() {
        MulliganScenarioTest scenario = new MulliganScenarioTest(MulliganType.SMOOTHED_LONDON, 1);
        Set<UUID> hand1 = new HashSet<>();
        scenario.mulligan(() -> {
            scenario.assertSizes(7, 33);
            hand1.addAll(scenario.getHand());
    ...
    @Test
    public void testSmoothedLondonMulligan_FreeMulligan_OneMulligan() {
        MulliganScenarioTest scenario = new MulliganScenarioTest(MulliganType.SMOOTHED_LONDON, 1);
        Set<UUID> hand1 = new HashSet<>();
        Set<UUID> hand2 = new HashSet<>();
        scenario.mulligan(() -> {
    ...
    @Test
    public void testSmoothedLondonMulligan_FreeMulligan_TwoMulligan() {
        MulliganScenarioTest scenario = new MulliganScenarioTest(MulliganType.SMOOTHED_LONDON, 1);
        Set<UUID> hand1 = new HashSet<>();
        Set<UUID> hand2 = new HashSet<>();
        Set<UUID> hand3 = new HashSet<>();
    ...
    @Test
    public void testSmoothedLondonMulligan_AlwaysMulligan() {
        MulliganScenarioTest scenario = new MulliganScenarioTest(MulliganType.SMOOTHED_LONDON, 0);
        scenario.mulligan(() -> {
            scenario.assertSizes(7, 33);
            return true;
