...
public class CommanderMutateTest extends CardTestCommanderDuelBase {
    ...
    protected Game createNewGameAndPlayers() throws GameException, FileNotFoundException {
        setDecknamePlayerA("CommanderDuel_Otrimi.dck"); // Commander = Otrimi, the Ever-Playful
    ...
    public void setupTestMutateCommanderBasic(boolean withToken, boolean mutateUnder) {
        ...
        castSpell(1, PhaseStep.POSTCOMBAT_MAIN, playerA, OTRIMI_THE_EVER_PLAYFUL + USING_MUTATE, withToken ? VAMPIRE : BEASTCALLER_SAVANT);
        ...
        assertPermanentCount(playerA, OTRIMI_THE_EVER_PLAYFUL, mutateUnder ? 0 : 1);
        String creature = mutateUnder ? withToken ? VAMPIRE : BEASTCALLER_SAVANT : OTRIMI_THE_EVER_PLAYFUL;
        ...
        assertPowerToughness(playerA, creature, mutateUnder ? withToken ? 1 : 1 : 6, mutateUnder ? withToken ? 1 : 1 : 6);
