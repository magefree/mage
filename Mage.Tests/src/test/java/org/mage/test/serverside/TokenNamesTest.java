...
public class TokenNamesTest extends CardTestPlayerBase {
    ...
    public void test_Rules_111_4_AutoGeneratedName() {
        Assertions.assertEquals("Human Cleric Token", new CreatureToken(2, 2, "", SubType.HUMAN, SubType.CLERIC).getName());
        Assertions.assertEquals("Warrior Token", new CreatureToken(2, 2, "", SubType.WARRIOR).getName());
        Assertions.assertEquals("Custom Name", new CreatureToken(2, 2, "", SubType.WARRIOR).withName("Custom Name").getName());
    }
}
