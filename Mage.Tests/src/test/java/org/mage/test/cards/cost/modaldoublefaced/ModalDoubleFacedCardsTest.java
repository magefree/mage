...
//            Assert.assertNull("server must have not other side", permanent.getOtherFace());
     ...
     */
    @Test
    public void test_Targeting_MDFC_FrontFace_CanBeTargetedByManaValueFilter() {
     ...
     */
    @Test
    public void test_ManaValue_MDFC_FrontFace_OnStack() {
        addCard(Zone.HAND, playerA, "Esika, God of the Tree");
        addCard(Zone.BATTLEFIELD, playerA, "Forest", 3);
    ...
    @Test
    public void test_ManaValue_MDFC_BackFace_OnStack() {
        addCard(Zone.HAND, playerA, "Esika, God of the Tree");
        addCard(Zone.BATTLEFIELD, playerA, "Plains");
        addCard(Zone.BATTLEFIELD, playerA, "Island");
        addCard(Zone.BATTLEFIELD, playerA, "Swamp");
    ...
    @Test
    public void test_Targeting_MDFC_BackFace_CannotBeTargetedByManaValueFilter() {
    ...
    @Test
    public void test_Moonmist_MustTransformAllDFC() {
