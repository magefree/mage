...
public class CloudshiftTest extends CardTestPlayerBase {
    ...
    public void testCopyEffectDiscarded() {
        ...
        Assert.assertTrue(clone.hasAbility(IntimidateAbility.getInstance(), currentGame));
        Assert.assertFalse(clone.hasAbility(LifelinkAbility.getInstance(), currentGame));
        Assert.assertFalse(clone.hasAbility(FirstStrikeAbility.getInstance(), currentGame));
    }
