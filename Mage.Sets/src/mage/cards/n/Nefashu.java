...
public final class Nefashu extends CardImpl {
    ...
    static final String RULE_TEXT = "Whenever Nefashu attacks, up to five target creatures each get -1/-1 until end of turn.";
    ...
    public Nefashu(UUID ownerId, CardSetInfo setInfo) {
        ...
        Ability ability = new AttacksTriggeredAbility(new BoostTargetEffect(-1, -1, Duration.EndOfTurn), false, RULE_TEXT);
