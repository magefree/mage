...
public final class NicolBolasTheRavager extends TransformingDoubleFacedCard {
    ...
    public NicolBolasTheRavager(UUID ownerId, CardSetInfo setInfo) {
        super(
                ...
                new SuperType[]{SuperType.LEGENDARY}, new CardType[]{CardType.PLANESWALKER}, new SubType[]{SubType.BOLAS}, "BRU"
        );
        ...
        this.getLeftHalfCard().addAbility(new EntersBattlefieldTriggeredAbility(new DiscardEachPlayerEffect(
...
class NicolBolasTheArisenEffect extends OneShotEffect {
    ...
    public boolean apply(Game game, Ability source) {
        ...
        return targetPlayer != null && controller != null
                && controller.moveCards(
                targetPlayer.getLibrary().getTopCards(
                        game, targetPlayer.getLibrary().size() - 1
