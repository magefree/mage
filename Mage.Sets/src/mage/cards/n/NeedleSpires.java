...
public final class NeedleSpires extends CardImpl {
    ...
    public NeedleSpires(UUID ownerId, CardSetInfo setInfo) {
        ...
        Effect effect = new BecomesCreatureSourceEffect(
            new CreatureToken(
                2, 1, "2/1 red and white Elemental creature with double strike", SubType.ELEMENTAL
            ).withColor("RW").withAbility(DoubleStrikeAbility.getInstance()),
            CardType.LAND,
            Duration.EndOfTurn
        ).setText("{this} becomes a 2/1 red and white Elemental creature with double strike until end of turn. It's still a land");
