...
public final class LordKitty extends CardImpl {
    ...
    private LordKitty(final LordKitty card) {
        super(card);
    }

    @Override
    public LordKitty copy() {
        return new LordKitty(this);
    }
}