...
class CantBeBlockedByTokenEffect extends RestrictionEffect {
    ...
    public void init(Ability source, Game game) {
        ...
        for (Permanent perm : game.getBattlefield().getActivePermanents(new FilterControlledCreaturePermanent(), source.getControllerId(), source.getSourceId(), source, game)) {
