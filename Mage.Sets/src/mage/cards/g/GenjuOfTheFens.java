    ...
    public GenjuOfTheFens(UUID ownerId, CardSetInfo setInfo) {
        ...
        this.addAbility(new SimpleActivatedAbility(
            new BecomesCreatureAttachedWithActivatedAbilityOrSpellEffect(
                new CreatureToken(2, 2, "2/2 black Spirit creature with \"{B}: This creature gets +1/+1 until end of turn.\"", SubType.SPIRIT)
                    .withColor("B")
                    .withAbility(new SimpleActivatedAbility(
                        new BoostSourceEffect(1, 1, Duration.EndOfTurn),
                        new ManaCostsImpl<>("{B}")
                    )),
                "Until end of turn, enchanted Swamp becomes a 2/2 black Spirit creature " +
                "with \"{B}: This creature gets +1/+1 until end of turn.\" It's still a land",
                Duration.EndOfTurn
            ),
