...
public final class GoShintaiOfBoundlessVigor extends CardImpl {
    ...
    private static final FilterPermanent filter = new FilterPermanent(SubType.SHRINE, "Shrine");
    ...
    public GoShintaiOfBoundlessVigor(UUID ownerId, CardSetInfo setInfo) {
        ...
        ReflexiveTriggeredAbility ability = new ReflexiveTriggeredAbility(new AddCountersTargetEffect(
                CounterType.P1P1.createInstance(0), ShrinesYouControlCount.FOR_EACH
        ), false);
