 ...
 * @author muz
 */
public final class GleamingBastion extends CardImpl {

    public GleamingBastion(UUID ownerId, CardSetInfo setInfo) {
    ...
    private GleamingBastion(final GleamingBastion card) {
        super(card);
    }

    @Override
    public GleamingBastion copy() {
        return new GleamingBastion(this);
    }
}
