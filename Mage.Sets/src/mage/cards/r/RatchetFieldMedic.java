...
public final class RatchetFieldMedic extends TransformingDoubleFacedCard {
    ...
    public RatchetFieldMedic(UUID ownerId, CardSetInfo setInfo) {
        ...
        this.getLeftHalfCard().addAbility(new GainLifeControllerTriggeredAbility(
...
class RatchetFieldMedicEffect extends OneShotEffect {
    ...
    RatchetFieldMedicEffect() {
        ...
        staticText = "convert {this}. When you do, return target artifact card with mana value less than or " +
                "equal to the amount of life you gained this turn from your graveyard to the battlefield tapped";
    }
