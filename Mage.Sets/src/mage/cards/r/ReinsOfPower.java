...
class ReinsOfPowerEffect extends OneShotEffect {
    ...
    public boolean apply(Game game, Ability source) {
        ...
        if (opponentId != null) {
            ...
            for (Permanent permanent : game.getBattlefield().getActivePermanents(new FilterControlledCreaturePermanent(), source.getControllerId(), source.getSourceId(), source, game)) {
            ...
            for (Permanent permanent : game.getBattlefield().getActivePermanents(filterOpponent, source.getControllerId(), source.getSourceId(), source, game)) {
