 ...
 * @author TheElk801
 */
public final class Revolutionist extends CardImpl {

    public Revolutionist(UUID ownerId, CardSetInfo setInfo) {
    ...
    @Override
    public Revolutionist copy() {
        return new Revolutionist(this);
    }
}
