...
class ResoluteStrikeEffect extends OneShotEffect {
    ...
    public boolean apply(Game game, Ability source) {
        ...
        if (player == null
                ...
                || game.getBattlefield().count(filter, source.getSourceId(), source.getControllerId(), source, game) == 0
        ...
        player.choose(outcome, targetPermanent, source.getSourceId(), source, game);
