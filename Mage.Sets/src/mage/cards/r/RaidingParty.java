        ...
        if (sourcePermanent != null) {
            ...
            for (UUID playerId : game.getState().getPlayersInRange(source.getControllerId(), game)) {
                ...
                if (player != null) {
                    ...
                    if (player.choose(Outcome.Benefit, untappedCreatureTarget, source.getSourceId(), source, game)) {
                    ...
                    if (tappedCount > 0) {
                        ...
                        if (player.choose(Outcome.Benefit, plainsToSaveTarget, source.getSourceId(), source, game)) {
            ...
            for (Permanent plains : game.getBattlefield().getActivePermanents(filter2, source.getControllerId(), source.getSourceId(), source, game)) {
