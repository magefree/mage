...
public final class RiverfallMimic extends CardImpl {
    ...
    public RiverfallMimic(UUID ownerId, CardSetInfo setInfo) {
        ...
        Ability ability = new SpellCastControllerTriggeredAbility(new SetPowerToughnessSourceEffect(3, 3, Duration.EndOfTurn, SubLayer.SetPT_7b, true), filter, false, rule);
