...
public final class RiverfallMimic extends CardImpl {
    ...
    private static final String RULE_TEXT = "Whenever you cast a spell that's both blue and red, {this} has base power and toughness 3/3 until end of turn and can't be blocked this turn.";
    ...
    public RiverfallMimic(UUID ownerId, CardSetInfo setInfo) {
        ...
        Ability ability = new SpellCastControllerTriggeredAbility(new SetBasePowerToughnessSourceEffect(3, 3, Duration.EndOfTurn, SubLayer.SetPT_7b), filter, false, RULE_TEXT);
