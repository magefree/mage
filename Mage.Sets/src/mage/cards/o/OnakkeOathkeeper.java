...
import mage.abilities.effects.common.combat.CantAttackControlledPlaneswalkerUnlessPayAllEffect;
...
public final class OnakkeOathkeeper extends CardImpl {
    ...
    public OnakkeOathkeeper(UUID ownerId, CardSetInfo setInfo) {
        ...
        this.addAbility(new SimpleStaticAbility(Zone.BATTLEFIELD, new CantAttackControlledPlaneswalkerUnlessPayAllEffect(new ManaCostsImpl<>("{1}"))));
