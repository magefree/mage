...
import mage.game.permanent.token.OsgoodOperationDoubleToken;
...
public final class OsgoodOperationDouble extends CardImpl {
    ...
    public OsgoodOperationDouble(UUID ownerId, CardSetInfo setInfo) {
        ...
        this.addAbility(new CastSourceTriggeredAbility(
            new CreateTokenEffect(new OsgoodOperationDoubleToken()).setText("create a token that's a copy of it, except it isn't legendary")
        ));
