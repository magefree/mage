...
public final class BarbedSliver extends CardImpl {
    ...
    public BarbedSliver(UUID ownerId, CardSetInfo setInfo) {
        ...
        this.addAbility(new SimpleStaticAbility(new GainAbilityAllEffect(new SimpleActivatedAbility(new BoostSourceEffect(1, 0, Duration.EndOfTurn).setText("this creature gets +1/+0 until end of turn"),
