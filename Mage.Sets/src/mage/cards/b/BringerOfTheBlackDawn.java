...
public final class BringerOfTheBlackDawn extends CardImpl {
    ...
    public BringerOfTheBlackDawn(UUID ownerId, CardSetInfo setInfo) {
        ...
        Ability ability = new BeginningOfUpkeepTriggeredAbility(new DoIfCostPaid(new SearchLibraryPutOnLibraryEffect(new TargetCardInLibrary(), false), new PayLifeCost(2)), TargetController.YOU, false);
