...
class DevastatingSummonsEffect extends OneShotEffect {
    ...
    public boolean apply(Game game, Ability source) {
        ...
        token.getPower().setModifiedBaseValue(GetXValue.instance.calculate(game, source, this));
        token.getToughness().setModifiedBaseValue(GetXValue.instance.calculate(game, source, this));
