...
public final class DangerBuggy extends CardImpl {
    ...
    private DangerBuggy(final DangerBuggy card) {
        super(card);
    }

    @Override
    public DangerBuggy copy() {
        return new DangerBuggy(this);
    }
}