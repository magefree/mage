 ...
 * @author muz
 */
public final class DarkFortress extends CardImpl {

    public DarkFortress(UUID ownerId, CardSetInfo setInfo) {
    ...
    private DarkFortress(final DarkFortress card) {
        super(card);
    }

    @Override
    public DarkFortress copy() {
        return new DarkFortress(this);
    }
}
