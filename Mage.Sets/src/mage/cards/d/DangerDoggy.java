 ...
 */
public final class DangerDoggy extends CardImpl {
    private static final FilterCreaturePermanent filter = new FilterCreaturePermanent(SubType.DOG, "Dogs");

    public DangerDoggy(UUID ownerId, CardSetInfo setInfo) {
    ...
    private DangerDoggy(final DangerDoggy card) {
        super(card);
    }

    @Override
    public DangerDoggy copy() {
        return new DangerDoggy(this);
    }
}