 ...
 */
public final class DangerPenguin extends CardImpl {
    private static final FilterCreaturePermanent filter = new FilterCreaturePermanent(SubType.BIRD, "Birds");

    public DangerPenguin(UUID ownerId, CardSetInfo setInfo) {
    ...
    private DangerPenguin(final DangerPenguin card) {
        super(card);
    }

    @Override
    public DangerPenguin copy() {
        return new DangerPenguin(this);
    }
}