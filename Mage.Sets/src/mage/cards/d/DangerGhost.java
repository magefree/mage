...
public final class DangerGhost extends CardImpl {
    ...
    private DangerGhost(final DangerGhost card) {
        super(card);
    }

    @Override
    public DangerGhost copy() {
        return new DangerGhost(this);
    }
}