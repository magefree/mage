 ...
 */
public final class DangerSnail extends CardImpl {
    private static final FilterCreaturePermanent filter = new FilterCreaturePermanent(SubType.SLUG, "Slugs");

    public DangerSnail(UUID ownerId, CardSetInfo setInfo) {
    ...
    private DangerSnail(final DangerSnail card) {
        super(card);
    }

    @Override
    public DangerSnail copy() {
        return new DangerSnail(this);
    }
}