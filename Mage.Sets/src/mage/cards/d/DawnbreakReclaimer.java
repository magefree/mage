...
class DawnbreakReclaimerEffect extends OneShotEffect {
    ...
    public boolean apply(Game game, Ability source) {
        ...
        if (controller != null
            ...
            if (chosenCreatureOpponentGraveyard.canChoose(source.getSourceId(), source.getControllerId(), source, game)) {
                controller.choose(Outcome.Detriment, chosenCreatureOpponentGraveyard, source.getSourceId(), source, game);
            ...
            if (opponent != null) {
                ...
                if (targetControllerGaveyard.canChoose(source.getSourceId(), opponent.getId(), source, game)
                        && opponent.choose(outcome, targetControllerGaveyard, source.getSourceId(), source, game)) {
