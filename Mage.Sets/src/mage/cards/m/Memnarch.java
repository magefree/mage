...
public final class Memnarch extends CardImpl {
    ...
    public Memnarch(UUID ownerId, CardSetInfo setInfo) {
        ...
        Ability ability = new SimpleActivatedAbility(effect, new ManaCostsImpl<>("{1}{U}{U}"));
        ability.addTarget(new TargetPermanent());
        this.addAbility(ability);

        // {3}{U}: Gain control of target artifact.
        Ability ability2 = new SimpleActivatedAbility(new GainControlTargetEffect(Duration.WhileOnBattlefield), new ManaCostsImpl<>("{3}{U}"));
