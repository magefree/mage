 ...
 * @author drowinternet
 */
public final class MonstruousStep extends CardImpl {
    ...
    public MonstruousStep(UUID ownerId, CardSetInfo setInfo) {
        ...
        this.getSpellAbility().addEffect(new MonstruousStepEffect());
    ...
    private MonstruousStep(final MonstruousStep card) {
        super(card);
    }

    @Override
    public MonstruousStep copy() {
        return new MonstruousStep(this);
    }
}

class MonstruousStepEffect extends RequirementEffect {

    public MonstruousStepEffect() {
        this(Duration.EndOfTurn);
    }

    public MonstruousStepEffect(Duration duration) {
        super(duration);
        staticText = "Target creature blocks target creature this turn if able";
    }

    public MonstruousStepEffect(final MonstruousStepEffect effect) {
        super(effect);
    }
    ...
    @Override
    public MonstruousStepEffect copy() {
        return new MonstruousStepEffect(this);
    }
