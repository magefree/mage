 ...
 * @author muz
 */
public final class MagnificentEnd extends CardImpl {
    ...
    public MagnificentEnd(UUID ownerId, CardSetInfo setInfo) {
    ...
    private MagnificentEnd(final MagnificentEnd card) {
        super(card);
    }

    @Override
    public MagnificentEnd copy() {
        return new MagnificentEnd(this);
    }
}
