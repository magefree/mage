...
import mage.abilities.effects.common.combat.RedirectAttackerTargetEffect;
...
public final class MisleadingSignpost extends CardImpl {
    ...
    public MisleadingSignpost(UUID ownerId, CardSetInfo setInfo) {
        ...
        Ability ability = new ConditionalTriggeredAbility(
                new EntersBattlefieldTriggeredAbility(new RedirectAttackerTargetEffect(true), true),
