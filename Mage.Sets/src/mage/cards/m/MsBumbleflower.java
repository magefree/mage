...
public final class MsBumbleflower extends CardImpl {
    ...
    public MsBumbleflower(UUID ownerId, CardSetInfo setInfo) {
        ...
        Effect counters = new AddCountersTargetEffect(CounterType.P1P1.createInstance()).setText(" Put a +1/+1 counter on target creature.");
        ...
        ability.addEffect(new IfAbilityHasResolvedXTimesEffect(2, new DrawCardSourceControllerEffect(2).setText("you draw two cards.")));
