...
public final class Mirrorpool extends CardImpl {
    ...
    public Mirrorpool(UUID ownerId, CardSetInfo setInfo) {
        ...
        Ability ability = new SimpleActivatedAbility(new CopyTargetStackObjectEffect(), new ManaCostsImpl<>("{2}{C}"));
        ...
        ability = new SimpleActivatedAbility(new CreateTokenCopyTargetEffect(), new ManaCostsImpl<>("{4}{C}"));
        ability.addCost(new TapSourceCost());
        ability.addCost(new SacrificeSourceCost());
