    ...
    public boolean apply(Game game, Ability source) {
        ...
        if (controller != null) {
            ...
            while (true) {
                ...
                if (target != null) {
                    if (target.canChoose(source.getSourceId(), controller.getId(), source, game) && controller.canRespond()) {
...
class UrzaAcademyHeadmasterManaEffect extends OneShotEffect {
    ...
    public boolean apply(Game game, Ability source) {
        ...
        if (player != null) {
            int x = game.getBattlefield().count(new FilterControlledCreaturePermanent(), source.getSourceId(), source.getControllerId(), source, game);
