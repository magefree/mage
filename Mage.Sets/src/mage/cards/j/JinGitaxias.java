...
public class JinGitaxias extends TransformingDoubleFacedCard {
    ...
    private static final FilterCreaturePermanent filter2 = new FilterCreaturePermanent("non-Phyrexian creatures");
    ...
    public JinGitaxias(UUID ownerId, CardSetInfo setInfo) {
        ...
        sagaAbility.addChapterEffect(
                this.getRightHalfCard(), SagaChapter.CHAPTER_I,
        ...
        // III — You may cast any number of spells from your hand without paying their mana cost. Exile The Great Synthesis, then return it to the battlefield <i>(front face up)</i>.
        sagaAbility.addChapterEffect(
                this.getRightHalfCard(), SagaChapter.CHAPTER_III,
                new TheGreatSynthesisCastEffect(), new ExileSourceAndReturnFaceUpEffect()
        );
