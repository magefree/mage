        ...
        if (player != null && sourceCreature != null) {
            ...
            if (type != null) {
                ...
                for (UUID playerId : game.getState().getPlayersInRange(source.getControllerId(), game)) {
                    ...
                    if (player2 != null && target.canChoose(source.getSourceId(), playerId, source, game)) {
                        while (player2.canRespond() && !target.isChosen() && target.canChoose(source.getSourceId(), playerId, source, game)) {
