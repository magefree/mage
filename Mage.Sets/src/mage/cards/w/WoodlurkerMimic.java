...
public final class WoodlurkerMimic extends CardImpl {
    ...
    public WoodlurkerMimic(UUID ownerId, CardSetInfo setInfo) {
        ...
        Ability ability = new SpellCastControllerTriggeredAbility(new SetPowerToughnessSourceEffect(4, 5, Duration.EndOfTurn, SubLayer.SetPT_7b, true), filter, false, rule);
