...
public final class WurmcoilLarva extends CardImpl {
    ...
    public WurmcoilLarva(UUID ownerId, CardSetInfo setInfo) {
        ...
        Ability ability = new DiesSourceTriggeredAbility(new CreateTokenEffect(new PhyrexianWurm12DeathtouchToken()).withAdditionalToken(new PhyrexianWurm21LifelinkToken()), false);
