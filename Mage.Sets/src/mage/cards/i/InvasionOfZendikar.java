...
public final class InvasionOfZendikar extends TransformingDoubleFacedCard {
    ...
    public InvasionOfZendikar(UUID ownerId, CardSetInfo setInfo) {
        ...
        this.getLeftHalfCard().addAbility(new EntersBattlefieldTriggeredAbility(new SearchLibraryPutInPlayEffect(
        ...
        this.getRightHalfCard().addAbility(new SimpleStaticAbility(new AddCardTypeSourceEffect(Duration.WhileOnBattlefield)
