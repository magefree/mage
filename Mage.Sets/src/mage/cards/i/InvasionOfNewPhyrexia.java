...
public final class InvasionOfNewPhyrexia extends TransformingDoubleFacedCard {
    ...
    public InvasionOfNewPhyrexia(UUID ownerId, CardSetInfo setInfo) {
        super(
                ...
                new SuperType[]{SuperType.LEGENDARY}, new CardType[]{CardType.PLANESWALKER}, new SubType[]{SubType.TEFERI}, "UW"
        );
        ...
        this.getLeftHalfCard().addAbility(new EntersBattlefieldTriggeredAbility(new CreateTokenEffect(new KnightWhiteBlueToken(), ManacostVariableValue.ETB)));
