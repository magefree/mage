...
public final class ErsatzGnomes extends CardImpl {
    ...
    public ErsatzGnomes(UUID ownerId, CardSetInfo setInfo) {
        ...
        Ability ability = new SimpleActivatedAbility(new BecomesColorTargetEffect(ObjectColor.COLORLESS, Duration.Custom), new TapSourceCost());
        ability.addTarget(new TargetSpell());
        this.addAbility(ability);

        // {T}: Target permanent becomes colorless until end of turn.
        ability = new SimpleActivatedAbility(new BecomesColorTargetEffect(ObjectColor.COLORLESS, Duration.EndOfTurn), new TapSourceCost());
