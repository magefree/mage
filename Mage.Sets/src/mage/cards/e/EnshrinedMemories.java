...
public final class EnshrinedMemories extends CardImpl {
    ...
    public EnshrinedMemories(UUID ownerId, CardSetInfo setInfo) {
        ...
        this.getSpellAbility().addEffect(new RevealLibraryPutIntoHandEffect(ManacostVariableValue.instance, StaticFilters.FILTER_CARD_CREATURES, Zone.LIBRARY, true));
    }
