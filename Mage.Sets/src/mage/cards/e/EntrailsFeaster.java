...
class EntrailsFeasterEffect extends OneShotEffect {
    ...
    public boolean apply(Game game, Ability source) {
        ...
        if (controller != null && source.getSourceId() != null) {
            ...
            if (target.canChoose(source.getSourceId(), controller.getId(), source, game) && controller.chooseUse(outcome, "Exile a creature card from a graveyard?", source, game)) {
                if (controller.choose(Outcome.Exile, target, source.getId(), source, game)) {
