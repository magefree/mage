...
public final class EssenceFlux extends CardImpl {
    ...
    public EssenceFlux(UUID ownerId, CardSetInfo setInfo) {
        ...
        this.getSpellAbility().addEffect(new ExileThenReturnTargetEffect(false, false).withAfterEffect(new EssenceFluxEffect()));
    }
...
class EssenceFluxEffect extends OneShotEffect {
    ...
    EssenceFluxEffect() {
        ...
        staticText = "If it's a Spirit, put a +1/+1 counter on it";
    }
