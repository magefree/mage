...
public final class ExoticCurse extends CardImpl {
    ...
    public ExoticCurse(UUID ownerId, CardSetInfo setInfo) {
        ...
        Ability ability = new SimpleStaticAbility(Zone.BATTLEFIELD, new BoostEnchantedEffect(unboost, unboost, Duration.WhileOnBattlefield).usingPhrasing(ValuePhrasing.FOR_EACH));
