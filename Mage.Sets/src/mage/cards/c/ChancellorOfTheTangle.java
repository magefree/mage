...
public final class ChancellorOfTheTangle extends CardImpl {
    ...
    private static final String ABILITY_TEXT = "at the beginning of your first main phase, add {G}";
    ...
    public ChancellorOfTheTangle(UUID ownerId, CardSetInfo setInfo) {
        ...
        this.addAbility(new ChancellorAbility(new ChancellorOfTheTangleDelayedTriggeredAbility(), ABILITY_TEXT));
