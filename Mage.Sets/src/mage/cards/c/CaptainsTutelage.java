 ...
 * @author muz
 */
public final class CaptainsTutelage extends CardImpl {

    public CaptainsTutelage(UUID ownerId, CardSetInfo setInfo) {
    ...
    private CaptainsTutelage(final CaptainsTutelage card) {
        super(card);
    }

    @Override
    public CaptainsTutelage copy() {
        return new CaptainsTutelage(this);
    }
}
