...
class ReleaseSacrificeEffect extends OneShotEffect {
    ...
    public boolean apply(Game game, Ability source) {
        ...
        for (UUID playerId : game.getState().getPlayersInRange(controller.getId(), game)) {
            ...
            if (target1.canChoose(source.getSourceId(), player.getId(), source, game)) {
                while (player.canRespond() && !target1.isChosen() && target1.canChoose(source.getSourceId(), player.getId(), source, game)) {
            ...
            if (target2.canChoose(source.getSourceId(), player.getId(), source, game)) {
                while (player.canRespond() && !target2.isChosen() && target2.canChoose(source.getSourceId(), player.getId(), source, game)) {
            ...
            if (target3.canChoose(source.getSourceId(), player.getId(), source, game)) {
                while (player.canRespond() && !target3.isChosen() && target3.canChoose(source.getSourceId(), player.getId(), source, game)) {
            ...
            if (target4.canChoose(source.getSourceId(), player.getId(), source, game)) {
                while (player.canRespond() && !target4.isChosen() && target4.canChoose(source.getSourceId(), player.getId(), source, game)) {
            ...
            if (target5.canChoose(source.getSourceId(), player.getId(), source, game)) {
                while (player.canRespond() && !target5.isChosen() && target5.canChoose(source.getSourceId(), player.getId(), source, game)) {
