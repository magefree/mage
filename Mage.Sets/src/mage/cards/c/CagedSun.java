...
class CagedSunTriggeredAbility extends TriggeredManaAbility {
    ...
    private static final String STATIC_TEXT = "Whenever a land's ability causes you to add one or more mana of the chosen color, add one additional mana of that color.";
