...
public final class TheStoneBrain extends CardImpl {
    ...
    public TheStoneBrain(UUID ownerId, CardSetInfo setInfo) {
        ...
        // {2}, {T}, Exile The Stone Brain: Choose a card name. Search target opponent's graveyard, hand, and library for up to four cards with that
        // name and exile them. That player shuffles, then draws a card for each card exiled from their hand this way. Activate only as a sorcery.
        Ability ability = new ActivateAsSorceryActivatedAbility(
                Zone.BATTLEFIELD, new ChooseACardNameEffect(ChooseACardNameEffect.TypeOfName.ALL), new GenericManaCost(2)
        );
...
class TheStoneBrainEffect extends OneShotEffect {
    ...
    public TheStoneBrainEffect(final TheStoneBrainEffect effect) {
        super(effect);
    }
