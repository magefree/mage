...
public final class ToughLizard extends CardImpl {
    ...
    private ToughLizard(final ToughLizard card) {
        super(card);
    }

    @Override
    public ToughLizard copy() {
        return new ToughLizard(this);
    }
}