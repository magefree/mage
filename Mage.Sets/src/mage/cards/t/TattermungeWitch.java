...
public final class TattermungeWitch extends CardImpl {
    ...
    public TattermungeWitch(UUID ownerId, CardSetInfo setInfo) {
        ...
        Ability ability = new SimpleActivatedAbility(new BoostAllEffect(1, 0, Duration.EndOfTurn, filter, false).setText("each blocked creature gets +1/+0"), new ManaCostsImpl<>("{R}{G}"));
