...
class TheAntiquitiesWarEffect extends ContinuousEffectImpl {
    ...
    public void init(Ability source, Game game) {
        ...
        for (Permanent perm : game.getBattlefield().getActivePermanents(StaticFilters.FILTER_CONTROLLED_PERMANENT_ARTIFACT, source.getControllerId(), source.getSourceId(), source, game)) {
