...
public final class TerminalMoraine extends CardImpl {
    ...
    public TerminalMoraine(UUID ownerId, CardSetInfo setInfo) {
        ...
        Ability ability = new SimpleActivatedAbility(new SearchLibraryPutInPlayEffect(new TargetCardInLibrary(StaticFilters.FILTER_CARD_BASIC_LAND), true, true), new ManaCostsImpl<>("{2}"));
