...
public class TheFifteenthDoctor extends CardImpl {
    ...
    public TheFifteenthDoctor(UUID ownerId, CardSetInfo setInfo) {
        ...
        this.addAbility(new EntersBattlefieldOrAttacksSourceTriggeredAbility(new TheFifteenthDoctorEffect()));
...
class TheFifteenthDoctorEffect extends OneShotEffect {
    ...
    private TheFifteenthDoctorEffect(final TheFifteenthDoctorEffect effect) {
        super(effect);
    }

    @Override
    public TheFifteenthDoctorEffect copy() {
        return new TheFifteenthDoctorEffect(this);
    }
...
class TheFifteenthDoctorSpellWatcher extends Watcher {
    ...
    public int nonartifactSpellsCastThisTurn(UUID playerId) {
        return nonartifactSpells.getOrDefault(playerId, 0);
    }
...
enum TheFifteenthDoctorCastSpellPredicate implements ObjectSourcePlayerPredicate<Card> {
    ...
    public boolean apply(ObjectSourcePlayer<Card> input, Game game) {
        if (!input.getObject().isArtifact(game)) {
    ...
    public String toString() {
        return "The first nonartifact spell you cast each turn";
    }
}
