        ...
        if (controller != null) {
            ...
            for (UUID playerId : game.getState().getPlayersInRange(controller.getId(), game)) {
                ...
                if (player != null) {
                    ...
                    if (target1.canChoose(source.getSourceId(), controller.getId(), source, game)) {
                    ...
                    if (target2.canChoose(source.getSourceId(), controller.getId(), source, game)) {
                    ...
                    if (target3.canChoose(source.getSourceId(), controller.getId(), source, game)) {
                    ...
                    if (target4.canChoose(source.getSourceId(), controller.getId(), source, game)) {
