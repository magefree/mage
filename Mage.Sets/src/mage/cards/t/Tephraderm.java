...
class TephradermCreatureDamageTriggeredAbility extends TriggeredAbilityImpl {
    ...
    public boolean checkTrigger(GameEvent event, Game game) {
        ...
        if (sourcePermanent != null
                && FILTER_CREATURE.match(sourcePermanent, getSourceId(), getControllerId(), this, game)) {
...
class TephradermSpellDamageTriggeredAbility extends TriggeredAbilityImpl {
    ...
    public boolean checkTrigger(GameEvent event, Game game) {
        ...
        if (sourceSpell != null && StaticFilters.FILTER_SPELL.match(sourceSpell, getSourceId(), getControllerId(), this, game)) {
            for (Effect effect : getEffects()) {
                if (effect instanceof DamageTargetEffect) {
