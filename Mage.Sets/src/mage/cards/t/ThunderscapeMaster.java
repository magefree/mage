...
public final class ThunderscapeMaster extends CardImpl {
    ...
    public ThunderscapeMaster(UUID ownerId, CardSetInfo setInfo) {
        ...
        Ability ability = new SimpleActivatedAbility(new LoseLifeTargetEffect(2), new ManaCostsImpl<>("{B}{B}"));
        ...
        ability = new SimpleActivatedAbility(new BoostControlledEffect(2, 2, Duration.EndOfTurn), new ManaCostsImpl<>("{G}{G}"));
        ability.addCost(new TapSourceCost());
        this.addAbility(ability);
    }
