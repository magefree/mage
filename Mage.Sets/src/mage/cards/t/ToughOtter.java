...
public final class ToughOtter extends CardImpl {
    ...
    private ToughOtter(final ToughOtter card) {
        super(card);
    }

    @Override
    public ToughOtter copy() {
        return new ToughOtter(this);
    }
}