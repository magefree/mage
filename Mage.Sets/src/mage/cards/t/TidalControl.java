...
public final class TidalControl extends CardImpl {
    ...
    public TidalControl(UUID ownerId, CardSetInfo setInfo) {
        ...
        SimpleActivatedAbility ability = new SimpleActivatedAbility(new CounterTargetEffect(), new OrCost("pay 2 life or pay {2}", new PayLifeCost(2), new ManaCostsImpl<>("{2}")));
