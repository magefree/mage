...
public final class HermitOfTheNatterknolls extends TransformingDoubleFacedCard {
    ...
    public HermitOfTheNatterknolls(UUID ownerId, CardSetInfo setInfo) {
        ...
        this.getLeftHalfCard().addAbility(new ConditionalTriggeredAbility(
                new SpellCastOpponentTriggeredAbility(
                        new DrawCardSourceControllerEffect(1), StaticFilters.FILTER_SPELL_A, false
                ), MyTurnCondition.instance, "Whenever an opponent casts a spell during your turn, draw a card."
        ...
        this.getRightHalfCard().addAbility(new ConditionalTriggeredAbility(
                new SpellCastOpponentTriggeredAbility(
                        new DrawCardSourceControllerEffect(2), StaticFilters.FILTER_SPELL_A, false
                ), MyTurnCondition.instance, "Whenever an opponent casts a spell during your turn, draw two cards."
        ).addHint(MyTurnHint.instance));
