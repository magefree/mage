...
public class HeliodTheRadiantDawn extends TransformingDoubleFacedCard {
    ...
    private static final FilterCard filter2 = new FilterNonlandCard("spells");
    ...
    public HeliodTheRadiantDawn(UUID ownerId, CardSetInfo setInfo) {
        super(
                ...
                new SuperType[]{SuperType.LEGENDARY}, new CardType[]{CardType.ENCHANTMENT, CardType.CREATURE}, new SubType[]{SubType.PHYREXIAN, SubType.GOD}, "UW"
        );
        ...
        this.getLeftHalfCard().addAbility(new ActivateAsSorceryActivatedAbility(
                new TransformSourceEffect(), new ManaCostsImpl<>("{3}{U/P}")
        ));
        ...
        this.getRightHalfCard().addAbility(new SimpleStaticAbility(new HeliodTheWarpedEclipseEffect()));
    }
