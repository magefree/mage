...
class HitEffect extends OneShotEffect {
    ...
    public boolean apply(Game game, Ability source) {
        ...
        if (targetPlayer != null) {
            ...
            if (target.canChoose(source.getSourceId(), targetPlayer.getId(), source, game)) {
                targetPlayer.choose(Outcome.Sacrifice, target, source.getSourceId(), source, game);
...
class RunEffect extends OneShotEffect {
    ...
    public boolean apply(Game game, Ability source) {
        ...
        if (controller != null) {
            int attackingCreatures = game.getBattlefield().count(new FilterAttackingCreature(), controller.getId(), controller.getId(), source, game);
