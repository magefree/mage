 ...
 * @author muz
 */
public final class HiddenLair extends CardImpl {

    public HiddenLair(UUID ownerId, CardSetInfo setInfo) {
        ...
        this.addAbility(new ActivateIfConditionManaAbility(
                Zone.BATTLEFIELD, new BasicManaEffect(Mana.BlueMana(1)),
        ...
        this.addAbility(new ActivateIfConditionManaAbility(
                Zone.BATTLEFIELD, new BasicManaEffect(Mana.BlackMana(1)),
                new TapSourceCost(), SourceEnteredOrControlsBasicLandCondition.instance
        ).addHint(SourceEnteredOrControlsBasicLandCondition.getHint()));
    }

    private HiddenLair(final HiddenLair card) {
        super(card);
    }

    @Override
    public HiddenLair copy() {
        return new HiddenLair(this);
    }
}
