...
public final class HarmattanEfreet extends CardImpl {
    ...
    public HarmattanEfreet(UUID ownerId, CardSetInfo setInfo) {
        ...
        SimpleActivatedAbility ability = new SimpleActivatedAbility(new GainAbilityTargetEffect(FlyingAbility.getInstance(), Duration.EndOfTurn), new ManaCostsImpl<>("{1}{U}{U}"));
