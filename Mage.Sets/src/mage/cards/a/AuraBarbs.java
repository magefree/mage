...
public final class AuraBarbs extends CardImpl {
    ...
    private static class AuraBarbsEffect extends OneShotEffect {
        ...
        public boolean apply(Game game, Ability source) {
            ...
            for (Permanent permanent : game.getBattlefield().getActivePermanents(filterEnchantments, source.getControllerId(), source.getSourceId(), source, game)) {
            ...
            for (Permanent auraEnchantment : game.getBattlefield().getActivePermanents(filterEnchantments, source.getControllerId(), source.getSourceId(), source, game)) {
