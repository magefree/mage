...
public final class AzusasManyJourneys extends TransformingDoubleFacedCard {
    ...
    public AzusasManyJourneys(UUID ownerId, CardSetInfo setInfo) {
        ...
        sagaAbility.addChapterEffect(
                ...
                new PlayAdditionalLandsControllerEffect(1, Duration.EndOfTurn)
        );

        // II — You gain 3 life.
        sagaAbility.addChapterEffect(
                this.getLeftHalfCard(), SagaChapter.CHAPTER_II, new GainLifeEffect(3)
        );
        ...
        this.getRightHalfCard().addAbility(new BecomesBlockedSourceTriggeredAbility(
                new UntapLandsEffect(3, true, true), false
        ));
    }
