...
public final class FoundryChampion extends CardImpl {
    ...
    public FoundryChampion(UUID ownerId, CardSetInfo setInfo) {
        ...
        Ability ability = new EntersBattlefieldTriggeredAbility(new DamageTargetEffect(CreaturesYouControlCount.instance, "it").withTextPhrasing(ValuePhrasing.EQUAL_TO).withTargetFirst());
