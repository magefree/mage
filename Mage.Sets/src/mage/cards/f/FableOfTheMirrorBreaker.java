...
public final class FableOfTheMirrorBreaker extends TransformingDoubleFacedCard {
    ...
    public FableOfTheMirrorBreaker(UUID ownerId, CardSetInfo setInfo) {
        super(
                ownerId, setInfo,
                new CardType[]{CardType.ENCHANTMENT}, new SubType[]{SubType.SAGA}, "{2}{R}",
                "Reflection of Kiki-Jiki",
                new CardType[]{CardType.ENCHANTMENT, CardType.CREATURE}, new SubType[]{SubType.GOBLIN, SubType.SHAMAN}, "R"
        );
