...
public final class Paleoloth extends CardImpl {
    ...
    private static final String RULE_TEXT = "Whenever another creature with power 5 or greater enters the battlefield under your control, you may return target creature card from your graveyard to your hand.";
    ...
    public Paleoloth(UUID ownerId, CardSetInfo setInfo) {
        ...
        Ability ability = new EntersBattlefieldControlledTriggeredAbility(Zone.BATTLEFIELD, new ReturnFromGraveyardToHandTargetEffect(), filter, true, RULE_TEXT);
