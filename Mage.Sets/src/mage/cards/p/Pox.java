        ...
        if (controller != null) {
            ...
            for (UUID playerId : game.getState().getPlayersInRange(controller.getId(), game)) {
                ...
                if (player != null) {
                    ...
                    int creaturesToSacrifice = (int) Math.ceil(game.getBattlefield().count(filter, source.getSourceId(), player.getId(), source, game) / 3.0);
            ...
            for (UUID playerId : game.getState().getPlayersInRange(controller.getId(), game)) {
                ...
                if (player != null) {
                    ...
                    int landsToSacrifice = (int) Math.ceil(game.getBattlefield().count(filter, source.getSourceId(), player.getId(), source, game) / 3.0);
