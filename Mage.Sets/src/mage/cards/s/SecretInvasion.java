...
public final class SecretInvasion extends CardImpl {
    ...
    public SecretInvasion(UUID ownerId, CardSetInfo setInfo) {
        ...
        // When this Aura enters, exile up to one target creature other than enchanted creature until this Aura leaves the battlefield.
        // Enchanted creature becomes a copy of that creature until this Aura leaves the battlefield.
...
class SecretInvasionEffect extends OneShotEffect {
    ...
    SecretInvasionEffect() {
        ...
        staticText = "exile up to one target creature other than enchanted creature until {this} leaves the battlefield. "
            + "Enchanted creature becomes a copy of that creature until {this} leaves the battlefield.";
    }
