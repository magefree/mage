...
public final class SinuousStriker extends CardImpl {
    ...
    private static final String RULE_TEXT = "Eternalize &mdash; {3}{U}{U}, Discard a card. <i>({3}{U}{U}, Discard a card, Exile this card from your graveyard: Create a token that's a copy of it, except it's a 4/4 black Zombie)</i>";
    ...
    public SinuousStriker(UUID ownerId, CardSetInfo cardSetInfo) {
        ...
        Ability ability = new EternalizeAbility(new ManaCostsImpl<>("{3}{U}{U}"), this, RULE_TEXT);
