...
public final class SkaabGoliath extends CardImpl {
    ...
    public SkaabGoliath(UUID ownerId, CardSetInfo setInfo) {
        ...
        this.getSpellAbility().addCost(new ExileFromGraveCost(new TargetCardInYourGraveyard(2, 2, StaticFilters.FILTER_CARD_CREATURES_YOUR_GRAVEYARD)).setAdditional(true));
