...
public final class ShapersOfNature extends CardImpl {
    ...
    public ShapersOfNature(UUID ownerId, CardSetInfo setInfo) {
        ...
        Ability ability = new SimpleActivatedAbility(new AddCountersTargetEffect(CounterType.P1P1.createInstance(1)), new ManaCostsImpl<>("{3}{G}"));
        ability.addTarget(new TargetCreaturePermanent());
        this.addAbility(ability);

        // {2}{U}, Remove a +1/+1 counter from a creature you control: Draw a card.
        ability = new SimpleActivatedAbility(new DrawCardSourceControllerEffect(1), new ManaCostsImpl<>("{2}{U}"));
