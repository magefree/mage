...
public final class SummoningMateria extends CardImpl {
    ...
    public SummoningMateria(UUID ownerId, CardSetInfo setInfo) {
        ...
        this.addAbility(new SimpleStaticAbility(new ConditionalContinuousEffect(
                new PlayFromTopOfLibraryEffect(StaticFilters.FILTER_CARD_CREATURE), condition, "as long as " +
                "{this} is attached to a creature, you may cast creature spells from the top of your library"
        )));
