...
public final class SunBlessedGuardian extends TransformingDoubleFacedCard {
    ...
    public SunBlessedGuardian(UUID ownerId, CardSetInfo setInfo) {
        super(
                ...
                new CardType[]{CardType.CREATURE}, new SubType[]{SubType.PHYREXIAN, SubType.CLERIC}, "RW"
        );
        ...
        this.getRightHalfCard().addAbility(new AttacksTriggeredAbility(new FurnaceBlessedConquerorEffect()));
    }
