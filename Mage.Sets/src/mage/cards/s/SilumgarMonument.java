    ...
    public SilumgarMonument(UUID ownerId, CardSetInfo setInfo) {
        ...
        this.addAbility(new SimpleActivatedAbility(
            new BecomesCreatureSourceEffect(
                new CreatureToken(
                    4, 4, "4/4 blue and black Dragon artifact creature with flying", SubType.DRAGON
                ).withColor("UB").withType(CardType.ARTIFACT).withAbility(FlyingAbility.getInstance()),
                CardType.ARTIFACT,
                Duration.EndOfTurn
            ),
