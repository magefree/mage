...
public final class SimicKeyrune extends CardImpl {
    ...
    public SimicKeyrune(UUID ownerId, CardSetInfo setInfo) {
        ...
        this.addAbility(new SimpleActivatedAbility(new BecomesCreatureSourceEffect(new SimicKeyruneToken(), CardType.ARTIFACT, Duration.EndOfTurn), new ManaCostsImpl<>("{G}{U}")));
    }
