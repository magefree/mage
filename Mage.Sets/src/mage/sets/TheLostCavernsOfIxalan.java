...
public final class TheLostCavernsOfIxalan extends ExpansionSet {
    ...
    private TheLostCavernsOfIxalan() {
        ...
        cards.add(new SetCardInfo("Master's Guide-Mural", 233, Rarity.UNCOMMON, mage.cards.m.MastersGuideMural.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Master's Manufactory", 233, Rarity.UNCOMMON, mage.cards.m.MastersManufactory.class, NON_FULL_USE_VARIOUS));
