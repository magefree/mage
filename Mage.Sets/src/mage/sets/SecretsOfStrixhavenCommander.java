...
public final class SecretsOfStrixhavenCommander extends ExpansionSet {
    ...
    private static final List<String> unfinished = Arrays.asList("Defacing Duskmage", "Dirgur Focusmage", "Eccentric Pestfinder", "Inspired Skypainter", "Lorehold Archivist", "Naktamun Lorespinner", "Stensian Sanguinist", "Striding Shotcaller");
