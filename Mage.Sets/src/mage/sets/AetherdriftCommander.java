...
public final class AetherdriftCommander extends ExpansionSet {
    ...
    private AetherdriftCommander() {
        ...
        cards.add(new SetCardInfo("Commence the Endgame", 38, Rarity.COMMON, mage.cards.c.CommenceTheEndgame.class));
        ...
        cards.add(new SetCardInfo("Swords to Plowshares", 37, Rarity.COMMON, mage.cards.s.SwordsToPlowshares.class));
