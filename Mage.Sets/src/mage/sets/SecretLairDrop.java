...
public class SecretLairDrop extends ExpansionSet {
    ...
    private SecretLairDrop() {
        ...
        cards.add(new SetCardInfo("Chaos Warp", 741, Rarity.RARE, mage.cards.c.ChaosWarp.class));
        ...
        cards.add(new SetCardInfo("Command Tower", 758, Rarity.RARE, mage.cards.c.CommandTower.class, FULL_ART_BFZ_VARIOUS));
        ...
        cards.add(new SetCardInfo("Rampaging Ferocidon", 1390, Rarity.RARE, mage.cards.r.RampagingFerocidon.class));
        cards.add(new SetCardInfo("Polyraptor", 1391, Rarity.MYTHIC, mage.cards.p.Polyraptor.class));
        cards.add(new SetCardInfo("Wayward Swordtooth", 1392, Rarity.RARE, mage.cards.w.WaywardSwordtooth.class));
        cards.add(new SetCardInfo("Regisaur Alpha", 1393, Rarity.RARE, mage.cards.r.RegisaurAlpha.class));
        ...
        cards.add(new SetCardInfo("Vona, Butcher of Magan", 1413, Rarity.MYTHIC, mage.cards.v.VonaButcherOfMagan.class));
        ...
        cards.add(new SetCardInfo("Mycosynth Golem", 1433, Rarity.RARE, mage.cards.m.MycosynthGolem.class));
        cards.add(new SetCardInfo("Mycosynth Lattice", 1434, Rarity.MYTHIC, mage.cards.m.MycosynthLattice.class));
        cards.add(new SetCardInfo("Mycosynth Wellspring", 1435, Rarity.RARE, mage.cards.m.MycosynthWellspring.class));
        ...
        cards.add(new SetCardInfo("Giver of Runes", 1463, Rarity.RARE, mage.cards.g.GiverOfRunes.class));
        cards.add(new SetCardInfo("Distant Melody", 1464, Rarity.RARE, mage.cards.d.DistantMelody.class));
        cards.add(new SetCardInfo("Cathartic Reunion", 1465, Rarity.RARE, mage.cards.c.CatharticReunion.class));
        cards.add(new SetCardInfo("Moment's Peace", 1466, Rarity.RARE, mage.cards.m.MomentsPeace.class));
        cards.add(new SetCardInfo("Homeward Path", 1467, Rarity.RARE, mage.cards.h.HomewardPath.class));
        ...
        cards.add(new SetCardInfo("Grand Arbiter Augustin IV", 1483, Rarity.RARE, mage.cards.g.GrandArbiterAugustinIV.class));
        cards.add(new SetCardInfo("Sphere of Resistance", 1484, Rarity.RARE, mage.cards.s.SphereOfResistance.class));
        cards.add(new SetCardInfo("Trinisphere", 1485, Rarity.MYTHIC, mage.cards.t.Trinisphere.class));
        cards.add(new SetCardInfo("Winter Orb", 1486, Rarity.RARE, mage.cards.w.WinterOrb.class));
        cards.add(new SetCardInfo("Felidar Guardian", 1487, Rarity.RARE, mage.cards.f.FelidarGuardian.class));
        cards.add(new SetCardInfo("Peregrine Drake", 1488, Rarity.RARE, mage.cards.p.PeregrineDrake.class));
        cards.add(new SetCardInfo("Serpent of Yawning Depths", 1489, Rarity.RARE, mage.cards.s.SerpentOfYawningDepths.class));
        cards.add(new SetCardInfo("Scourge of Valkas", 1490, Rarity.MYTHIC, mage.cards.s.ScourgeOfValkas.class));
        ...
        cards.add(new SetCardInfo("Time Stop", 1500, Rarity.RARE, mage.cards.t.TimeStop.class));
        ...
        cards.add(new SetCardInfo("Wall of Omens", 1518, Rarity.RARE, mage.cards.w.WallOfOmens.class));
        cards.add(new SetCardInfo("Circular Logic", 1519, Rarity.RARE, mage.cards.c.CircularLogic.class));
        cards.add(new SetCardInfo("Scheming Symmetry", 1520, Rarity.RARE, mage.cards.s.SchemingSymmetry.class));
        cards.add(new SetCardInfo("Price of Progress", 1521, Rarity.RARE, mage.cards.p.PriceOfProgress.class));
        ...
        cards.add(new SetCardInfo("Reflecting Pool", 1535, Rarity.RARE, mage.cards.r.ReflectingPool.class));
        ...
        cards.add(new SetCardInfo("Prince of Thralls", 1549, Rarity.MYTHIC, mage.cards.p.PrinceOfThralls.class));
        ...
        cards.add(new SetCardInfo("Shelter", 1587, Rarity.RARE, mage.cards.s.Shelter.class));
        cards.add(new SetCardInfo("Diabolic Tutor", 1592, Rarity.RARE, mage.cards.d.DiabolicTutor.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Chandra's Ignition", 1594, Rarity.RARE, mage.cards.c.ChandrasIgnition.class));
        ...
        cards.add(new SetCardInfo("Sigarda's Aid", 1727, Rarity.RARE, mage.cards.s.SigardasAid.class));
        ...
        cards.add(new SetCardInfo("Commander's Plate", 1733, Rarity.MYTHIC, mage.cards.c.CommandersPlate.class));
        cards.add(new SetCardInfo("Sol Ring", 1734, Rarity.RARE, mage.cards.s.SolRing.class));
        ...
        cards.add(new SetCardInfo("Berserk", 1738, Rarity.MYTHIC, mage.cards.b.Berserk.class));
        ...
        cards.add(new SetCardInfo("Lightning Bolt", 1743, Rarity.RARE, mage.cards.l.LightningBolt.class));
        ...
        cards.add(new SetCardInfo("Primal Vigor", 1749, Rarity.RARE, mage.cards.p.PrimalVigor.class));
