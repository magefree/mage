...
public class SecretLairDrop extends ExpansionSet {
    ...
    private SecretLairDrop() {
        ...
        // workaround to fix compilation error: java: code too large (each part is ~1000 cards pack)
        addPart1(); // a-h
        addPart2(); // i-r
        addPart3(); // s-z
    }
    ...
    private void addPart1() {
        ...
        cards.add(new SetCardInfo("Abundant Growth", 1135, Rarity.RARE, mage.cards.a.AbundantGrowth.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Abundant Growth", 870, Rarity.RARE, mage.cards.a.AbundantGrowth.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Academy Manufactor", 2195, Rarity.RARE, mage.cards.a.AcademyManufactor.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Anger", 1637, Rarity.RARE, mage.cards.a.Anger.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Anger", 2375, Rarity.RARE, mage.cards.a.Anger.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Anhelo, the Painter", 2353, Rarity.MYTHIC, mage.cards.a.AnheloThePainter.class));
        ...
        cards.add(new SetCardInfo("Arcane Denial", 1545, Rarity.RARE, mage.cards.a.ArcaneDenial.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Arcane Denial", 2489, Rarity.RARE, mage.cards.a.ArcaneDenial.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Beast Within", 2671, Rarity.RARE, mage.cards.b.BeastWithin.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Beast Within", 323, Rarity.RARE, mage.cards.b.BeastWithin.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Black Market", 1577, Rarity.RARE, mage.cards.b.BlackMarket.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Black Market", 2485, Rarity.RARE, mage.cards.b.BlackMarket.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Black Panther, Wakandan King", 1747, Rarity.MYTHIC, mage.cards.b.BlackPantherWakandanKing.class));
        //cards.add(new SetCardInfo("Blacker Lotus", 869, Rarity.RARE, mage.cards.b.BlackerLotus.class));
        ...
        cards.add(new SetCardInfo("Blasphemous Act", 1998, Rarity.RARE, mage.cards.b.BlasphemousAct.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Bloodghast", 2351, Rarity.RARE, mage.cards.b.Bloodghast.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Bloody Betrayal", 7102, Rarity.RARE, mage.cards.b.BloodyBetrayal.class));
        ...
        cards.add(new SetCardInfo("Boseiju, Who Shelters All", 426, Rarity.RARE, mage.cards.b.BoseijuWhoSheltersAll.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Brainstorm", 2491, Rarity.RARE, mage.cards.b.Brainstorm.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Brightstone Ritual", 2409, Rarity.RARE, mage.cards.b.BrightstoneRitual.class));
        ...
        cards.add(new SetCardInfo("Broadside Bombardiers", 2410, Rarity.RARE, mage.cards.b.BroadsideBombardiers.class));
        ...
        cards.add(new SetCardInfo("Chord of Calling", 2376, Rarity.RARE, mage.cards.c.ChordOfCalling.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Conspicuous Snoop", 2411, Rarity.RARE, mage.cards.c.ConspicuousSnoop.class));
        ...
        cards.add(new SetCardInfo("Counterbalance", 1220, Rarity.RARE, mage.cards.c.Counterbalance.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Counterspell", 2497, Rarity.RARE, mage.cards.c.Counterspell.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Crucible of Worlds", 2110, Rarity.MYTHIC, mage.cards.c.CrucibleOfWorlds.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Cryptic Command", 905, Rarity.RARE, mage.cards.c.CrypticCommand.class));
        ...
        //cards.add(new SetCardInfo("Deadpool, Trading Card", 1753, Rarity.MYTHIC, mage.cards.d.DeadpoolTradingCard.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Delver of Secrets", 2367, Rarity.RARE, mage.cards.d.DelverOfSecrets.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Empty the Warrens", 2412, Rarity.RARE, mage.cards.e.EmptyTheWarrens.class));
        ...
        cards.add(new SetCardInfo("Estrid, the Masked", "1327b", Rarity.MYTHIC, mage.cards.e.EstridTheMasked.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Estrid, the Masked", 1327, Rarity.MYTHIC, mage.cards.e.EstridTheMasked.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Fact or Fiction", 1995, Rarity.RARE, mage.cards.f.FactOrFiction.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Farseek", 2222, Rarity.RARE, mage.cards.f.Farseek.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Fell the Mighty", 1778, Rarity.RARE, mage.cards.f.FellTheMighty.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Forest", 1092, Rarity.LAND, mage.cards.basiclands.Forest.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Forest", 1134, Rarity.LAND, mage.cards.basiclands.Forest.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Forest", 1194, Rarity.LAND, mage.cards.basiclands.Forest.class, RETRO_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Forest", 1386, Rarity.LAND, mage.cards.basiclands.Forest.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Forest", 1403, Rarity.LAND, mage.cards.basiclands.Forest.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Forest", 1472, Rarity.LAND, mage.cards.basiclands.Forest.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Forest", 1482, Rarity.LAND, mage.cards.basiclands.Forest.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Forest", 1515, Rarity.LAND, mage.cards.basiclands.Forest.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Forest", 1651, Rarity.LAND, mage.cards.basiclands.Forest.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Forest", 1656, Rarity.LAND, mage.cards.basiclands.Forest.class, RETRO_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Forest", 1943, Rarity.LAND, mage.cards.basiclands.Forest.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Forest", 1949, Rarity.LAND, mage.cards.basiclands.Forest.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Forest", 1954, Rarity.LAND, mage.cards.basiclands.Forest.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Forest", 2080, Rarity.LAND, mage.cards.basiclands.Forest.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Forest", 243, Rarity.LAND, mage.cards.basiclands.Forest.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Forest", 2513, Rarity.LAND, mage.cards.basiclands.Forest.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Forest", 2544, Rarity.LAND, mage.cards.basiclands.Forest.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Forest", 258, Rarity.LAND, mage.cards.basiclands.Forest.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Forest", 363, Rarity.LAND, mage.cards.basiclands.Forest.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Forest", 388, Rarity.LAND, mage.cards.basiclands.Forest.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Forest", 395, Rarity.LAND, mage.cards.basiclands.Forest.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Forest", 419, Rarity.LAND, mage.cards.basiclands.Forest.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Forest", 452, Rarity.LAND, mage.cards.basiclands.Forest.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Forest", 476, Rarity.LAND, mage.cards.basiclands.Forest.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Forest", 488, Rarity.LAND, mage.cards.basiclands.Forest.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Forest", 50, Rarity.LAND, mage.cards.basiclands.Forest.class, FULL_ART_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Forest", 67, Rarity.LAND, mage.cards.basiclands.Forest.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Forest", 690, Rarity.LAND, mage.cards.basiclands.Forest.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Forest", 892, Rarity.LAND, mage.cards.basiclands.Forest.class, FULL_ART_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Frantic Search", 1996, Rarity.RARE, mage.cards.f.FranticSearch.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Future Sight", 1178, Rarity.RARE, mage.cards.f.FutureSight.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Goblin Chieftain", 1615, Rarity.RARE, mage.cards.g.GoblinChieftain.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Grand Arbiter Augustin IV", 1483, Rarity.RARE, mage.cards.g.GrandArbiterAugustinIV.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Grapeshot", 2413, Rarity.RARE, mage.cards.g.Grapeshot.class));
        ...
        cards.add(new SetCardInfo("Higure, the Still Wind", 2368, Rarity.RARE, mage.cards.h.HigureTheStillWind.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Howling Mine", 7046, Rarity.RARE, mage.cards.h.HowlingMine.class, NON_FULL_USE_VARIOUS));
    ...
    private void addPart2() {
        ...
        cards.add(new SetCardInfo("Impact Tremors", 1999, Rarity.RARE, mage.cards.i.ImpactTremors.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Ink-Eyes, Servant of Oni", 2374, Rarity.RARE, mage.cards.i.InkEyesServantOfOni.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Island", 1089, Rarity.LAND, mage.cards.basiclands.Island.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Island", 1131, Rarity.LAND, mage.cards.basiclands.Island.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Island", 1191, Rarity.LAND, mage.cards.basiclands.Island.class, RETRO_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Island", 1383, Rarity.LAND, mage.cards.basiclands.Island.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Island", 1400, Rarity.LAND, mage.cards.basiclands.Island.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Island", 1469, Rarity.LAND, mage.cards.basiclands.Island.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Island", 1479, Rarity.LAND, mage.cards.basiclands.Island.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Island", 1648, Rarity.LAND, mage.cards.basiclands.Island.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Island", 1653, Rarity.LAND, mage.cards.basiclands.Island.class, RETRO_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Island", 1940, Rarity.LAND, mage.cards.basiclands.Island.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Island", 1946, Rarity.LAND, mage.cards.basiclands.Island.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Island", 1951, Rarity.LAND, mage.cards.basiclands.Island.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Island", 2077, Rarity.LAND, mage.cards.basiclands.Island.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Island", 2144, Rarity.LAND, mage.cards.basiclands.Island.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Island", 2145, Rarity.LAND, mage.cards.basiclands.Island.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Island", 2146, Rarity.LAND, mage.cards.basiclands.Island.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Island", 2147, Rarity.LAND, mage.cards.basiclands.Island.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Island", 240, Rarity.LAND, mage.cards.basiclands.Island.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Island", 2510, Rarity.LAND, mage.cards.basiclands.Island.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Island", 2541, Rarity.LAND, mage.cards.basiclands.Island.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Island", 255, Rarity.LAND, mage.cards.basiclands.Island.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Island", 360, Rarity.LAND, mage.cards.basiclands.Island.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Island", 385, Rarity.LAND, mage.cards.basiclands.Island.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Island", 386, Rarity.LAND, mage.cards.basiclands.Island.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Island", 392, Rarity.LAND, mage.cards.basiclands.Island.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Island", 416, Rarity.LAND, mage.cards.basiclands.Island.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Island", 449, Rarity.LAND, mage.cards.basiclands.Island.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Island", 466, Rarity.LAND, mage.cards.basiclands.Island.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Island", 47, Rarity.LAND, mage.cards.basiclands.Island.class, FULL_ART_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Island", 64, Rarity.LAND, mage.cards.basiclands.Island.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Island", 673, Rarity.LAND, mage.cards.basiclands.Island.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Island", 889, Rarity.LAND, mage.cards.basiclands.Island.class, FULL_ART_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("It That Betrays", 1176, Rarity.RARE, mage.cards.i.ItThatBetrays.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Krenko, Mob Boss", 2407, Rarity.RARE, mage.cards.k.KrenkoMobBoss.class));
        ...
        cards.add(new SetCardInfo("Lier, Disciple of the Drowned", 2350, Rarity.MYTHIC, mage.cards.l.LierDiscipleOfTheDrowned.class));
        ...
        //cards.add(new SetCardInfo("Mechtitan", "1969b", Rarity.COMMON, mage.cards.m.Mechtitan.class, NON_FULL_USE_VARIOUS));
        //cards.add(new SetCardInfo("Mechtitan", 1969, Rarity.COMMON, mage.cards.m.Mechtitan.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Mental Misstep", 2373, Rarity.RARE, mage.cards.m.MentalMisstep.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Mindcrank", 2186, Rarity.RARE, mage.cards.m.Mindcrank.class, NON_FULL_USE_VARIOUS));
        ...
        //cards.add(new SetCardInfo("Minsc & Boo, Timeless Heroes", 879, Rarity.MYTHIC, mage.cards.m.MinscAndBooTimelessHeroes.class));
        ...
        cards.add(new SetCardInfo("Moggcatcher", 7081, Rarity.RARE, mage.cards.m.Moggcatcher.class));
        ...
        cards.add(new SetCardInfo("Mountain", 1091, Rarity.LAND, mage.cards.basiclands.Mountain.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Mountain", 1133, Rarity.LAND, mage.cards.basiclands.Mountain.class, FULL_ART_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Mountain", 1385, Rarity.LAND, mage.cards.basiclands.Mountain.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Mountain", 1402, Rarity.LAND, mage.cards.basiclands.Mountain.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Mountain", 1471, Rarity.LAND, mage.cards.basiclands.Mountain.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Mountain", 1481, Rarity.LAND, mage.cards.basiclands.Mountain.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Mountain", 1514, Rarity.LAND, mage.cards.basiclands.Mountain.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Mountain", 1650, Rarity.LAND, mage.cards.basiclands.Mountain.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Mountain", 1655, Rarity.LAND, mage.cards.basiclands.Mountain.class, RETRO_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Mountain", 1942, Rarity.LAND, mage.cards.basiclands.Mountain.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Mountain", 1948, Rarity.LAND, mage.cards.basiclands.Mountain.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Mountain", 1953, Rarity.LAND, mage.cards.basiclands.Mountain.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Mountain", 2079, Rarity.LAND, mage.cards.basiclands.Mountain.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Mountain", 2418, Rarity.LAND, mage.cards.basiclands.Mountain.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Mountain", 2419, Rarity.LAND, mage.cards.basiclands.Mountain.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Mountain", 242, Rarity.LAND, mage.cards.basiclands.Mountain.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Mountain", 2420, Rarity.LAND, mage.cards.basiclands.Mountain.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Mountain", 2512, Rarity.LAND, mage.cards.basiclands.Mountain.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Mountain", 2543, Rarity.LAND, mage.cards.basiclands.Mountain.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Mountain", 257, Rarity.LAND, mage.cards.basiclands.Mountain.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Mountain", 362, Rarity.LAND, mage.cards.basiclands.Mountain.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Mountain", 387, Rarity.LAND, mage.cards.basiclands.Mountain.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Mountain", 389, Rarity.LAND, mage.cards.basiclands.Mountain.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Mountain", 418, Rarity.LAND, mage.cards.basiclands.Mountain.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Mountain", 451, Rarity.LAND, mage.cards.basiclands.Mountain.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Mountain", 487, Rarity.LAND, mage.cards.basiclands.Mountain.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Mountain", 49, Rarity.LAND, mage.cards.basiclands.Mountain.class, FULL_ART_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Mountain", 66, Rarity.LAND, mage.cards.basiclands.Mountain.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Mountain", 674, Rarity.LAND, mage.cards.basiclands.Mountain.class, FULL_ART_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Mountain", 891, Rarity.LAND, mage.cards.basiclands.Mountain.class, FULL_ART_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Muxus, Goblin Grandee", 1314, Rarity.RARE, mage.cards.m.MuxusGoblinGrandee.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Mycoloth", 1136, Rarity.RARE, mage.cards.m.Mycoloth.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Orim's Chant", 2669, Rarity.RARE, mage.cards.o.OrimsChant.class));
        ...
        cards.add(new SetCardInfo("Pashalik Mons", 2408, Rarity.RARE, mage.cards.p.PashalikMons.class));
        ...
        cards.add(new SetCardInfo("Plains", 1088, Rarity.LAND, mage.cards.basiclands.Plains.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Plains", 1130, Rarity.LAND, mage.cards.basiclands.Plains.class, FULL_ART_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Plains", 1382, Rarity.LAND, mage.cards.basiclands.Plains.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Plains", 1399, Rarity.LAND, mage.cards.basiclands.Plains.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Plains", 1468, Rarity.LAND, mage.cards.basiclands.Plains.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Plains", 1478, Rarity.LAND, mage.cards.basiclands.Plains.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Plains", 1513, Rarity.LAND, mage.cards.basiclands.Plains.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Plains", 1647, Rarity.LAND, mage.cards.basiclands.Plains.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Plains", 1652, Rarity.LAND, mage.cards.basiclands.Plains.class, RETRO_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Plains", 1939, Rarity.LAND, mage.cards.basiclands.Plains.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Plains", 1945, Rarity.LAND, mage.cards.basiclands.Plains.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Plains", 1950, Rarity.LAND, mage.cards.basiclands.Plains.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Plains", 2076, Rarity.LAND, mage.cards.basiclands.Plains.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Plains", 239, Rarity.LAND, mage.cards.basiclands.Plains.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Plains", 2509, Rarity.LAND, mage.cards.basiclands.Plains.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Plains", 254, Rarity.LAND, mage.cards.basiclands.Plains.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Plains", 2540, Rarity.LAND, mage.cards.basiclands.Plains.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Plains", 359, Rarity.LAND, mage.cards.basiclands.Plains.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Plains", 390, Rarity.LAND, mage.cards.basiclands.Plains.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Plains", 391, Rarity.LAND, mage.cards.basiclands.Plains.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Plains", 393, Rarity.LAND, mage.cards.basiclands.Plains.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Plains", 415, Rarity.LAND, mage.cards.basiclands.Plains.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Plains", 448, Rarity.LAND, mage.cards.basiclands.Plains.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Plains", 46, Rarity.LAND, mage.cards.basiclands.Plains.class, FULL_ART_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Plains", 63, Rarity.LAND, mage.cards.basiclands.Plains.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Plains", 670, Rarity.LAND, mage.cards.basiclands.Plains.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Plains", 888, Rarity.LAND, mage.cards.basiclands.Plains.class, FULL_ART_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Ponder", 2670, Rarity.RARE, mage.cards.p.Ponder.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Rampaging Baloths", 2370, Rarity.RARE, mage.cards.r.RampagingBaloths.class));
        ...
        cards.add(new SetCardInfo("Regrowth", 866, Rarity.RARE, mage.cards.r.Regrowth.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Rin and Seri, Inseparable", 2668, Rarity.MYTHIC, mage.cards.r.RinAndSeriInseparable.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Roaming Throne", 2415, Rarity.RARE, mage.cards.r.RoamingThrone.class));
    ...
    private void addPart3() {
        ...
        cards.add(new SetCardInfo("Scheming Symmetry", 1520, Rarity.RARE, mage.cards.s.SchemingSymmetry.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Scheming Symmetry", 1997, Rarity.RARE, mage.cards.s.SchemingSymmetry.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Seasoned Dungeoneer", 2505, Rarity.RARE, mage.cards.s.SeasonedDungeoneer.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Settle the Wreckage", 2372, Rarity.RARE, mage.cards.s.SettleTheWreckage.class));
        ...
        cards.add(new SetCardInfo("Shiny Impetus", 7165, Rarity.RARE, mage.cards.s.ShinyImpetus.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Silver Shroud Costume", 915, Rarity.RARE, mage.cards.s.SilverShroudCostume.class));
        ...
        cards.add(new SetCardInfo("Skirk Prospector", 2414, Rarity.RARE, mage.cards.s.SkirkProspector.class));
        ...
        cards.add(new SetCardInfo("Skullclamp", 2416, Rarity.RARE, mage.cards.s.Skullclamp.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Snow-Covered Forest", "1477*", Rarity.LAND, mage.cards.s.SnowCoveredForest.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Snow-Covered Forest", 1477, Rarity.LAND, mage.cards.s.SnowCoveredForest.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Snow-Covered Forest", 329, Rarity.LAND, mage.cards.s.SnowCoveredForest.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Snow-Covered Forest", 5, Rarity.LAND, mage.cards.s.SnowCoveredForest.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Snow-Covered Island", "1474*", Rarity.LAND, mage.cards.s.SnowCoveredIsland.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Snow-Covered Island", 1474, Rarity.LAND, mage.cards.s.SnowCoveredIsland.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Snow-Covered Island", 2, Rarity.LAND, mage.cards.s.SnowCoveredIsland.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Snow-Covered Island", 326, Rarity.LAND, mage.cards.s.SnowCoveredIsland.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Snow-Covered Mountain", "1476*", Rarity.LAND, mage.cards.s.SnowCoveredMountain.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Snow-Covered Mountain", 1476, Rarity.LAND, mage.cards.s.SnowCoveredMountain.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Snow-Covered Mountain", 328, Rarity.LAND, mage.cards.s.SnowCoveredMountain.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Snow-Covered Mountain", 4, Rarity.LAND, mage.cards.s.SnowCoveredMountain.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Snow-Covered Plains", "1473*", Rarity.LAND, mage.cards.s.SnowCoveredPlains.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Snow-Covered Plains", 1, Rarity.LAND, mage.cards.s.SnowCoveredPlains.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Snow-Covered Plains", 1473, Rarity.LAND, mage.cards.s.SnowCoveredPlains.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Snow-Covered Plains", 325, Rarity.LAND, mage.cards.s.SnowCoveredPlains.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Snow-Covered Swamp", "1475*", Rarity.LAND, mage.cards.s.SnowCoveredSwamp.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Snow-Covered Swamp", 1475, Rarity.LAND, mage.cards.s.SnowCoveredSwamp.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Snow-Covered Swamp", 3, Rarity.LAND, mage.cards.s.SnowCoveredSwamp.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Snow-Covered Swamp", 327, Rarity.LAND, mage.cards.s.SnowCoveredSwamp.class, FULL_ART_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Sol Ring", 2417, Rarity.RARE, mage.cards.s.SolRing.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Sol Ring", 2672, Rarity.RARE, mage.cards.s.SolRing.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Species Specialist", 2369, Rarity.RARE, mage.cards.s.SpeciesSpecialist.class));
        ...
        cards.add(new SetCardInfo("Steely Resolve", "1326b", Rarity.RARE, mage.cards.s.SteelyResolve.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Storm-Kiln Artist", 2352, Rarity.RARE, mage.cards.s.StormKilnArtist.class));
        ...
        cards.add(new SetCardInfo("Swamp", 1090, Rarity.LAND, mage.cards.basiclands.Swamp.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Swamp", 1132, Rarity.LAND, mage.cards.basiclands.Swamp.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Swamp", 119, Rarity.LAND, mage.cards.basiclands.Swamp.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Swamp", 1192, Rarity.LAND, mage.cards.basiclands.Swamp.class, RETRO_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Swamp", 1384, Rarity.LAND, mage.cards.basiclands.Swamp.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Swamp", 1401, Rarity.LAND, mage.cards.basiclands.Swamp.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Swamp", 1470, Rarity.LAND, mage.cards.basiclands.Swamp.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Swamp", 1480, Rarity.LAND, mage.cards.basiclands.Swamp.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Swamp", 1649, Rarity.LAND, mage.cards.basiclands.Swamp.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Swamp", 1654, Rarity.LAND, mage.cards.basiclands.Swamp.class, RETRO_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Swamp", 1941, Rarity.LAND, mage.cards.basiclands.Swamp.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Swamp", 1947, Rarity.LAND, mage.cards.basiclands.Swamp.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Swamp", 1952, Rarity.LAND, mage.cards.basiclands.Swamp.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Swamp", 2078, Rarity.LAND, mage.cards.basiclands.Swamp.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Swamp", 241, Rarity.LAND, mage.cards.basiclands.Swamp.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Swamp", 2511, Rarity.LAND, mage.cards.basiclands.Swamp.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Swamp", 2542, Rarity.LAND, mage.cards.basiclands.Swamp.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Swamp", 256, Rarity.LAND, mage.cards.basiclands.Swamp.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Swamp", 361, Rarity.LAND, mage.cards.basiclands.Swamp.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Swamp", 384, Rarity.LAND, mage.cards.basiclands.Swamp.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Swamp", 394, Rarity.LAND, mage.cards.basiclands.Swamp.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Swamp", 417, Rarity.LAND, mage.cards.basiclands.Swamp.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Swamp", 450, Rarity.LAND, mage.cards.basiclands.Swamp.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Swamp", 48, Rarity.LAND, mage.cards.basiclands.Swamp.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Swamp", 486, Rarity.LAND, mage.cards.basiclands.Swamp.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Swamp", 539, Rarity.LAND, mage.cards.basiclands.Swamp.class, FULL_ART_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Swamp", 65, Rarity.LAND, mage.cards.basiclands.Swamp.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Swamp", 890, Rarity.LAND, mage.cards.basiclands.Swamp.class, FULL_ART_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Triskelion", 2371, Rarity.RARE, mage.cards.t.Triskelion.class));
        ...
        cards.add(new SetCardInfo("Tuvasa the Sunlit", "1328b", Rarity.MYTHIC, mage.cards.t.TuvasaTheSunlit.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Tuvasa the Sunlit", 1328, Rarity.MYTHIC, mage.cards.t.TuvasaTheSunlit.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Utopia Sprawl", 409, Rarity.RARE, mage.cards.u.UtopiaSprawl.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Wastes", "795*", Rarity.RARE, mage.cards.w.Wastes.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Wastes", 704, Rarity.RARE, mage.cards.w.Wastes.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Wastes", 705, Rarity.RARE, mage.cards.w.Wastes.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Wastes", 706, Rarity.RARE, mage.cards.w.Wastes.class, FULL_ART_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Witch Enchanter", 2655, Rarity.RARE, mage.cards.w.WitchEnchanter.class));
        ...
        cards.add(new SetCardInfo("Xorn", 2495, Rarity.RARE, mage.cards.x.Xorn.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Xorn", 876, Rarity.RARE, mage.cards.x.Xorn.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Zada, Hedron Grinder", 2406, Rarity.RARE, mage.cards.z.ZadaHedronGrinder.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Zada, Hedron Grinder", 2423, Rarity.RARE, mage.cards.z.ZadaHedronGrinder.class, NON_FULL_USE_VARIOUS));
