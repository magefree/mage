...
//        cards.add(new SetCardInfo("The Fifteenth Doctor", 1584, Rarity.RARE, mage.cards.t.TheFifteenthDoctor.class));
    ...
    private void addPart3() {
        ...
        cards.add(new SetCardInfo("Zada, Hedron Grinder", 2406, Rarity.RARE, mage.cards.z.ZadaHedronGrinder.class));
        ...
        cards.add(new SetCardInfo("Swords to Plowshares", 2663, Rarity.RARE, mage.cards.s.SwordsToPlowshares.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Counterspell", 2664, Rarity.RARE, mage.cards.c.Counterspell.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Dark Ritual", 2665, Rarity.RARE, mage.cards.d.DarkRitual.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Earthquake", 2666, Rarity.RARE, mage.cards.e.Earthquake.class, FULL_ART));
        cards.add(new SetCardInfo("Fog", 2667, Rarity.RARE, mage.cards.f.Fog.class, FULL_ART));
        ...
        cards.add(new SetCardInfo("Dungeon Delver", 7103, Rarity.RARE, mage.cards.d.DungeonDelver.class, FULL_ART));
