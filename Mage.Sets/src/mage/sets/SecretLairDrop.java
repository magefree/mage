...
public class SecretLairDrop extends ExpansionSet {
    ...
    private SecretLairDrop() {
        ...
        cards.add(new SetCardInfo("Arcane Signet", 201, Rarity.RARE, mage.cards.a.ArcaneSignet.class));
        ...
        cards.add(new SetCardInfo("Commander's Sphere", 203, Rarity.RARE, mage.cards.c.CommandersSphere.class));
