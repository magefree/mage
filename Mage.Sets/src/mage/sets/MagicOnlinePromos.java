...
public class MagicOnlinePromos extends ExpansionSet {
    ...
    private MagicOnlinePromos() {
        ...
        final CardGraphicInfo MPR_FULL_ART = new CardGraphicInfo(FrameStyle.MPRP_FULL_ART_BASIC, true);
        ...
        cards.add(new SetCardInfo("Abrade", 65001, Rarity.UNCOMMON, mage.cards.a.Abrade.class));
        ...
        cards.add(new SetCardInfo("Ancient Stirrings", 70944, Rarity.MYTHIC, mage.cards.a.AncientStirrings.class));
        ...
        cards.add(new SetCardInfo("Bituminous Blast", 36857, Rarity.UNCOMMON, mage.cards.b.BituminousBlast.class, MPR_FULL_ART));
        ...
        cards.add(new SetCardInfo("Blightning", 35124, Rarity.COMMON, mage.cards.b.Blightning.class, MPR_FULL_ART));
        ...
        cards.add(new SetCardInfo("Blue Elemental Blast", 70922, Rarity.MYTHIC, mage.cards.b.BlueElementalBlast.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Boros Signet", 62393, Rarity.COMMON, mage.cards.b.BorosSignet.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Brainstorm", 70920, Rarity.MYTHIC, mage.cards.b.Brainstorm.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Brave the Elements", 37857, Rarity.UNCOMMON, mage.cards.b.BraveTheElements.class, MPR_FULL_ART));
        ...
        cards.add(new SetCardInfo("Burst Lightning", 37610, Rarity.COMMON, mage.cards.b.BurstLightning.class, MPR_FULL_ART));
        ...
        cards.add(new SetCardInfo("Cancel", 36222, Rarity.COMMON, mage.cards.c.Cancel.class, MPR_FULL_ART));
        ...
        cards.add(new SetCardInfo("Celestial Purge", 36859, Rarity.UNCOMMON, mage.cards.c.CelestialPurge.class, MPR_FULL_ART));
        // Planechase Plane. Card not implemented.
        ...
        cards.add(new SetCardInfo("Circle of Flame", 41648, Rarity.COMMON, mage.cards.c.CircleOfFlame.class));
        ...
        cards.add(new SetCardInfo("Condemn", 31385, Rarity.UNCOMMON, mage.cards.c.Condemn.class, MPR_FULL_ART));
        ...
        cards.add(new SetCardInfo("Corrupt", 35120, Rarity.UNCOMMON, mage.cards.c.Corrupt.class, MPR_FULL_ART));
        ...
        cards.add(new SetCardInfo("Cruel Edict", 35062, Rarity.RARE, mage.cards.c.CruelEdict.class, MPR_FULL_ART));
        ...
        cards.add(new SetCardInfo("Cryptic Command", 31447, Rarity.RARE, mage.cards.c.CrypticCommand.class, MPR_FULL_ART));
        ...
        cards.add(new SetCardInfo("Damnation", 31417, Rarity.RARE, mage.cards.d.Damnation.class, MPR_FULL_ART));
        ...
        cards.add(new SetCardInfo("Day of Judgment", 37873, Rarity.RARE, mage.cards.d.DayOfJudgment.class, MPR_FULL_ART));
        ...
        cards.add(new SetCardInfo("Disenchant", 31397, Rarity.COMMON, mage.cards.d.Disenchant.class, MPR_FULL_ART));
        ...
        cards.add(new SetCardInfo("Doom Blade", 37855, Rarity.COMMON, mage.cards.d.DoomBlade.class, MPR_FULL_ART));
        ...
        cards.add(new SetCardInfo("Fireball", 31485, Rarity.UNCOMMON, mage.cards.f.Fireball.class, MPR_FULL_ART));
        ...
        cards.add(new SetCardInfo("Flame Javelin", 35122, Rarity.UNCOMMON, mage.cards.f.FlameJavelin.class, MPR_FULL_ART));
        ...
        cards.add(new SetCardInfo("Giant Growth", 35824, Rarity.COMMON, mage.cards.g.GiantGrowth.class, MPR_FULL_ART));
        cards.add(new SetCardInfo("Giant Growth", 35930, Rarity.COMMON, mage.cards.g.GiantGrowth.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Gideon Jura", 65003, Rarity.MYTHIC, mage.cards.g.GideonJura.class));
        cards.add(new SetCardInfo("Gideon of the Trials", 70940, Rarity.MYTHIC, mage.cards.g.GideonOfTheTrials.class));
        cards.add(new SetCardInfo("Gifts Ungiven", 70924, Rarity.MYTHIC, mage.cards.g.GiftsUngiven.class));
        ...
        // Set-exclusive, not legal card. Not implemented. See https://scryfall.com/card/prm/26584/gleemox
        ...
        cards.add(new SetCardInfo("Hada Freeblade", 43558, Rarity.COMMON, mage.cards.h.HadaFreeblade.class));
        ...
        cards.add(new SetCardInfo("Harmonize", 35106, Rarity.UNCOMMON, mage.cards.h.Harmonize.class, MPR_FULL_ART));
        cards.add(new SetCardInfo("Harrow", 37612, Rarity.COMMON, mage.cards.h.Harrow.class, MPR_FULL_ART));
        ...
        cards.add(new SetCardInfo("Hinder", 35172, Rarity.UNCOMMON, mage.cards.h.Hinder.class, MPR_FULL_ART));
        ...
        cards.add(new SetCardInfo("Incinerate", 31419, Rarity.COMMON, mage.cards.i.Incinerate.class, MPR_FULL_ART));
        ...
        cards.add(new SetCardInfo("Infest", 43568, Rarity.UNCOMMON, mage.cards.i.Infest.class, MPR_FULL_ART));
        ...
        cards.add(new SetCardInfo("Jokulhaups", 70942, Rarity.MYTHIC, mage.cards.j.Jokulhaups.class));
        ...
        cards.add(new SetCardInfo("Lightning Bolt", 36224, Rarity.COMMON, mage.cards.l.LightningBolt.class, MPR_FULL_ART));
        ...
        cards.add(new SetCardInfo("Lightning Helix", 31487, Rarity.UNCOMMON, mage.cards.l.LightningHelix.class, MPR_FULL_ART));
        ...
        cards.add(new SetCardInfo("Mana Leak", 31481, Rarity.COMMON, mage.cards.m.ManaLeak.class, MPR_FULL_ART));
        cards.add(new SetCardInfo("Mana Tithe", 35108, Rarity.COMMON, mage.cards.m.ManaTithe.class, MPR_FULL_ART));
        ...
        cards.add(new SetCardInfo("Mortify", 35046, Rarity.UNCOMMON, mage.cards.m.Mortify.class, MPR_FULL_ART));
        ...
        cards.add(new SetCardInfo("Mystical Tutor", 70926, Rarity.MYTHIC, mage.cards.m.MysticalTutor.class));
        cards.add(new SetCardInfo("Nalathni Dragon", 35956, Rarity.RARE, mage.cards.n.NalathniDragon.class));
        cards.add(new SetCardInfo("Nameless Inversion", 35126, Rarity.COMMON, mage.cards.n.NamelessInversion.class, MPR_FULL_ART));
        ...
        cards.add(new SetCardInfo("Negate", 35138, Rarity.COMMON, mage.cards.n.Negate.class, MPR_FULL_ART));
        cards.add(new SetCardInfo("Negate", 70930, Rarity.MYTHIC, mage.cards.n.Negate.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Oxidize", 35162, Rarity.UNCOMMON, mage.cards.o.Oxidize.class, MPR_FULL_ART));
        ...
        cards.add(new SetCardInfo("Pendelhaven", 65660, Rarity.UNCOMMON, mage.cards.p.Pendelhaven.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Ponder", 35118, Rarity.COMMON, mage.cards.p.Ponder.class, MPR_FULL_ART));
        ...
        cards.add(new SetCardInfo("Psionic Blast", 35058, Rarity.RARE, mage.cards.p.PsionicBlast.class, MPR_FULL_ART));
        cards.add(new SetCardInfo("Psychatog", 31467, Rarity.UNCOMMON, mage.cards.p.Psychatog.class));
        cards.add(new SetCardInfo("Putrefy", 35166, Rarity.UNCOMMON, mage.cards.p.Putrefy.class, MPR_FULL_ART));
        cards.add(new SetCardInfo("Pyroblast", 69981, Rarity.COMMON, mage.cards.p.Pyroblast.class));
        cards.add(new SetCardInfo("Pyroclasm", 35168, Rarity.UNCOMMON, mage.cards.p.Pyroclasm.class, MPR_FULL_ART));
        ...
        cards.add(new SetCardInfo("Rampant Growth", 35128, Rarity.COMMON, mage.cards.r.RampantGrowth.class, MPR_FULL_ART));
        ...
        cards.add(new SetCardInfo("Reciprocate", 35164, Rarity.UNCOMMON, mage.cards.r.Reciprocate.class, MPR_FULL_ART));
        ...
        cards.add(new SetCardInfo("Recollect", 35060, Rarity.UNCOMMON, mage.cards.r.Recollect.class, MPR_FULL_ART));
        ...
        cards.add(new SetCardInfo("Remove Soul", 35130, Rarity.COMMON, mage.cards.r.RemoveSoul.class, MPR_FULL_ART));
        ...
        cards.add(new SetCardInfo("Rupture", 62417, Rarity.RARE, mage.cards.r.Rupture.class));
        ...
        cards.add(new SetCardInfo("Sandsteppe Citadel", 57606, Rarity.RARE, mage.cards.s.SandsteppeCitadel.class));
        ...
        cards.add(new SetCardInfo("Searing Blaze", 39630, Rarity.COMMON, mage.cards.s.SearingBlaze.class, MPR_FULL_ART));
        ...
        cards.add(new SetCardInfo("Sign in Blood", 36226, Rarity.COMMON, mage.cards.s.SignInBlood.class));
        ...
        cards.add(new SetCardInfo("Spatial Contortion", 61555, Rarity.COMMON, mage.cards.s.SpatialContortion.class));
        ...
        cards.add(new SetCardInfo("Stoke the Flames", 54553, Rarity.RARE, mage.cards.s.StokeTheFlames.class));
        ...
        cards.add(new SetCardInfo("Sylvan Library", 23948, Rarity.UNCOMMON, mage.cards.s.SylvanLibrary.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Terminate", 35136, Rarity.COMMON, mage.cards.t.Terminate.class, MPR_FULL_ART));
        ...
        cards.add(new SetCardInfo("Terror", 31483, Rarity.COMMON, mage.cards.t.Terror.class, MPR_FULL_ART));
        ...
        cards.add(new SetCardInfo("Threads of Disloyalty", 70928, Rarity.MYTHIC, mage.cards.t.ThreadsOfDisloyalty.class));
        cards.add(new SetCardInfo("Thunder Spirit", 229, Rarity.RARE, mage.cards.t.ThunderSpirit.class));
        ...
        cards.add(new SetCardInfo("Tidings", 35076, Rarity.UNCOMMON, mage.cards.t.Tidings.class, MPR_FULL_ART));
        ...
        cards.add(new SetCardInfo("Treasure Hunt", 39632, Rarity.COMMON, mage.cards.t.TreasureHunt.class, MPR_FULL_ART));
        ...
        cards.add(new SetCardInfo("Unmake", 32551, Rarity.COMMON, mage.cards.u.Unmake.class, MPR_FULL_ART));
        ...
        cards.add(new SetCardInfo("Volcanic Fallout", 43570, Rarity.UNCOMMON, mage.cards.v.VolcanicFallout.class, MPR_FULL_ART));
        ...
        cards.add(new SetCardInfo("Wrath of God", 35048, Rarity.RARE, mage.cards.w.WrathOfGod.class, MPR_FULL_ART));
        ...
        cards.add(new SetCardInfo("Zombify", 35170, Rarity.UNCOMMON, mage.cards.z.Zombify.class, MPR_FULL_ART));
