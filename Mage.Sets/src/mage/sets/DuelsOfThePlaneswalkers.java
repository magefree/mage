...
public final class DuelsOfThePlaneswalkers extends ExpansionSet {
    ...
    private DuelsOfThePlaneswalkers() {
        ...
        cards.add(new SetCardInfo("Forest", 110, Rarity.COMMON, mage.cards.basiclands.Forest.class));
        cards.add(new SetCardInfo("Forest", 111, Rarity.COMMON, mage.cards.basiclands.Forest.class));
        cards.add(new SetCardInfo("Forest", 112, Rarity.COMMON, mage.cards.basiclands.Forest.class));
        cards.add(new SetCardInfo("Forest", 113, Rarity.COMMON, mage.cards.basiclands.Forest.class));
        ...
        cards.add(new SetCardInfo("Island", 100, Rarity.COMMON, mage.cards.basiclands.Island.class));
        cards.add(new SetCardInfo("Island", 101, Rarity.COMMON, mage.cards.basiclands.Island.class));
        cards.add(new SetCardInfo("Island", 98, Rarity.COMMON, mage.cards.basiclands.Island.class));
        cards.add(new SetCardInfo("Island", 99, Rarity.COMMON, mage.cards.basiclands.Island.class));
        ...
        cards.add(new SetCardInfo("Mountain", 106, Rarity.COMMON, mage.cards.basiclands.Mountain.class));
        cards.add(new SetCardInfo("Mountain", 107, Rarity.COMMON, mage.cards.basiclands.Mountain.class));
        cards.add(new SetCardInfo("Mountain", 108, Rarity.COMMON, mage.cards.basiclands.Mountain.class));
        cards.add(new SetCardInfo("Mountain", 109, Rarity.COMMON, mage.cards.basiclands.Mountain.class));
        ...
        cards.add(new SetCardInfo("Swamp", 102, Rarity.COMMON, mage.cards.basiclands.Swamp.class));
        cards.add(new SetCardInfo("Swamp", 103, Rarity.COMMON, mage.cards.basiclands.Swamp.class));
        cards.add(new SetCardInfo("Swamp", 104, Rarity.COMMON, mage.cards.basiclands.Swamp.class));
        cards.add(new SetCardInfo("Swamp", 105, Rarity.COMMON, mage.cards.basiclands.Swamp.class));
