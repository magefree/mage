...
public final class TalesOfMiddleEarthCommander extends ExpansionSet {
    ...
    private TalesOfMiddleEarthCommander() {
        ...
        cards.add(new SetCardInfo("Aragorn, King of Gondor", 448, Rarity.MYTHIC, mage.cards.a.AragornKingOfGondor.class));
        cards.add(new SetCardInfo("Arbor Elf", 232, Rarity.COMMON, mage.cards.a.ArborElf.class));
        cards.add(new SetCardInfo("Arboreal Alliance", 541, Rarity.RARE, mage.cards.a.ArborealAlliance.class));
        ...
        cards.add(new SetCardInfo("Archivist of Gondor", 420, Rarity.RARE, mage.cards.a.ArchivistOfGondor.class));
        cards.add(new SetCardInfo("Arwen, Weaver of Hope", 437, Rarity.RARE, mage.cards.a.ArwenWeaverOfHope.class));
        ...
        cards.add(new SetCardInfo("Assemble the Entmoot", 119, Rarity.RARE, mage.cards.a.AssembleTheEntmoot.class));
        ...
        cards.add(new SetCardInfo("Bilbo, Birthday Celebrant", 451, Rarity.RARE, mage.cards.b.BilboBirthdayCelebrant.class));
        ...
        cards.add(new SetCardInfo("Boromir, Gondor's Hope", 452, Rarity.RARE, mage.cards.b.BoromirGondorsHope.class));
        ...
        cards.add(new SetCardInfo("Cavern-Hoard Dragon", 114, Rarity.RARE, mage.cards.c.CavernHoardDragon.class));
        ...
        cards.add(new SetCardInfo("Cirdan the Shipwright", 133, Rarity.RARE, mage.cards.c.CirdanTheShipwright.class));
        ...
        cards.add(new SetCardInfo("Elrond of the White Council", 134, Rarity.RARE, mage.cards.e.ElrondOfTheWhiteCouncil.class));
        ...
        cards.add(new SetCardInfo("Eomer, King of Rohan", 135, Rarity.RARE, mage.cards.e.EomerKingOfRohan.class));
        cards.add(new SetCardInfo("Eowyn, Shieldmaiden", 81, Rarity.MYTHIC, mage.cards.e.EowynShieldmaiden.class));
        cards.add(new SetCardInfo("Erestor of the Council", 457, Rarity.RARE, mage.cards.e.ErestorOfTheCouncil.class));
        ...
        cards.add(new SetCardInfo("Faramir, Steward of Gondor", 458, Rarity.RARE, mage.cards.f.FaramirStewardOfGondor.class));
        cards.add(new SetCardInfo("Farhaven Elf", 243, Rarity.COMMON, mage.cards.f.FarhavenElf.class));
        cards.add(new SetCardInfo("Farmer Cotton", 459, Rarity.RARE, mage.cards.f.FarmerCotton.class));
        ...
        cards.add(new SetCardInfo("Forth Eorlingas!", 139, Rarity.RARE, mage.cards.f.ForthEorlingas.class));
        ...
        cards.add(new SetCardInfo("Galadriel, Elven-Queen", 83, Rarity.MYTHIC, mage.cards.g.GaladrielElvenQueen.class));
        cards.add(new SetCardInfo("Galadriel, Light of Valinor", 498, Rarity.MYTHIC, mage.cards.g.GaladrielLightOfValinor.class));
        cards.add(new SetCardInfo("Gandalf, Westward Voyager", 89, Rarity.MYTHIC, mage.cards.g.GandalfWestwardVoyager.class));
        ...
        cards.add(new SetCardInfo("Gilraen, Dunedain Protector", 97, Rarity.RARE, mage.cards.g.GilraenDunedainProtector.class));
        cards.add(new SetCardInfo("Gimli of the Glittering Caves", 115, Rarity.RARE, mage.cards.g.GimliOfTheGlitteringCaves.class));
        ...
        cards.add(new SetCardInfo("Gollum, Obsessed Stalker", 428, Rarity.RARE, mage.cards.g.GollumObsessedStalker.class));
        ...
        cards.add(new SetCardInfo("Grey Host Reinforcements", 416, Rarity.RARE, mage.cards.g.GreyHostReinforcements.class));
        cards.add(new SetCardInfo("Grima, Saruman's Footman", 140, Rarity.RARE, mage.cards.g.GrimaSarumansFootman.class));
        ...
        cards.add(new SetCardInfo("Legolas Greenleaf", 442, Rarity.RARE, mage.cards.l.LegolasGreenleaf.class));
        ...
        cards.add(new SetCardInfo("Lord of the Nazgul", 467, Rarity.RARE, mage.cards.l.LordOfTheNazgul.class));
        cards.add(new SetCardInfo("Lossarnach Captain", 16, Rarity.RARE, mage.cards.l.LossarnachCaptain.class));
        cards.add(new SetCardInfo("Lothlorien Blade", 487, Rarity.RARE, mage.cards.l.LothlorienBlade.class));
        ...
        cards.add(new SetCardInfo("Merry, Warden of Isengard", 143, Rarity.RARE, mage.cards.m.MerryWardenOfIsengard.class));
        ...
        cards.add(new SetCardInfo("Mirkwood Elk", 443, Rarity.RARE, mage.cards.m.MirkwoodElk.class));
        cards.add(new SetCardInfo("Mirkwood Trapper", 62, Rarity.RARE, mage.cards.m.MirkwoodTrapper.class));
        cards.add(new SetCardInfo("Model of Unity", 488, Rarity.RARE, mage.cards.m.ModelOfUnity.class));
        cards.add(new SetCardInfo("Monstrosity of the Lake", 424, Rarity.RARE, mage.cards.m.MonstrosityOfTheLake.class));
        ...
        cards.add(new SetCardInfo("Motivated Pony", 444, Rarity.RARE, mage.cards.m.MotivatedPony.class));
        ...
        cards.add(new SetCardInfo("Oath of Eorl", 471, Rarity.RARE, mage.cards.o.OathOfEorl.class));
        ...
        cards.add(new SetCardInfo("Orcish Siegemaster", 116, Rarity.RARE, mage.cards.o.OrcishSiegemaster.class));
        ...
        cards.add(new SetCardInfo("Prize Pig", 126, Rarity.RARE, mage.cards.p.PrizePig.class));
        ...
        cards.add(new SetCardInfo("Rampaging War Mammoth", 436, Rarity.RARE, mage.cards.r.RampagingWarMammoth.class));
        cards.add(new SetCardInfo("Rampant Growth", 257, Rarity.COMMON, mage.cards.r.RampantGrowth.class));
        cards.add(new SetCardInfo("Rapacious Guest", 111, Rarity.RARE, mage.cards.r.RapaciousGuest.class));
        ...
        cards.add(new SetCardInfo("Relic of Sauron", 489, Rarity.RARE, mage.cards.r.RelicOfSauron.class));
        cards.add(new SetCardInfo("Revenge of Ravens", 207, Rarity.UNCOMMON, mage.cards.r.RevengeOfRavens.class));
        cards.add(new SetCardInfo("Riders of Rohan", 474, Rarity.RARE, mage.cards.r.RidersOfRohan.class));
        ...
        cards.add(new SetCardInfo("Sail into the West", 149, Rarity.RARE, mage.cards.s.SailIntoTheWest.class));
        cards.add(new SetCardInfo("Sam, Loyal Attendant", 90, Rarity.MYTHIC, mage.cards.s.SamLoyalAttendant.class));
        ...
        cards.add(new SetCardInfo("Shelob, Dread Weaver", 112, Rarity.RARE, mage.cards.s.ShelobDreadWeaver.class));
        ...
        cards.add(new SetCardInfo("Song of Earendil", 479, Rarity.RARE, mage.cards.s.SongOfEarendil.class));
        ...
        cards.add(new SetCardInfo("Subjugate the Hobbits", 107, Rarity.RARE, mage.cards.s.SubjugateTheHobbits.class));
        ...
        cards.add(new SetCardInfo("Summons of Saruman", 480, Rarity.RARE, mage.cards.s.SummonsOfSaruman.class));
        ...
        cards.add(new SetCardInfo("Taunt from the Rampart", 481, Rarity.RARE, mage.cards.t.TauntFromTheRampart.class));
        ...
        cards.add(new SetCardInfo("The Black Gate", 160, Rarity.RARE, mage.cards.t.TheBlackGate.class));
        cards.add(new SetCardInfo("The Gaffer", 414, Rarity.RARE, mage.cards.t.TheGaffer.class));
        ...
        cards.add(new SetCardInfo("Trap the Trespassers", 108, Rarity.RARE, mage.cards.t.TrapTheTrespassers.class));
        cards.add(new SetCardInfo("Travel Through Caradhras", 127, Rarity.RARE, mage.cards.t.TravelThroughCaradhras.class));
        cards.add(new SetCardInfo("Treasure Nabber", 230, Rarity.RARE, mage.cards.t.TreasureNabber.class));
        cards.add(new SetCardInfo("Treebeard, Gracious Host", 153, Rarity.RARE, mage.cards.t.TreebeardGraciousHost.class));
        ...
        cards.add(new SetCardInfo("Wake the Dragon", 154, Rarity.RARE, mage.cards.w.WakeTheDragon.class));
        ...
        cards.add(new SetCardInfo("Windswift Slice", 447, Rarity.RARE, mage.cards.w.WindswiftSlice.class));
