...
public final class PhyrexiaAllWillBeOne extends ExpansionSet {
    ...
    private PhyrexiaAllWillBeOne() {
        ...
        cards.add(new SetCardInfo("Conduit of Worlds", 163, Rarity.COMMON, mage.cards.c.ConduitOfWorlds.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Conduit of Worlds", 390, Rarity.COMMON, mage.cards.c.ConduitOfWorlds.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("The Mycosynth Gardens", 256, Rarity.RARE, mage.cards.t.TheMycosynthGardens.class));
        ...
        cards.add(new SetCardInfo("Zenith Chronicler", 246, Rarity.RARE, mage.cards.z.ZenithChronicler.class));
