...
public final class DuskmournHouseOfHorrorCommander extends ExpansionSet {
    ...
    private DuskmournHouseOfHorrorCommander() {
        ...
        cards.add(new SetCardInfo("Barbflare Gremlin", 26, Rarity.RARE, mage.cards.b.BarbflareGremlin.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Barbflare Gremlin", 55, Rarity.RARE, mage.cards.b.BarbflareGremlin.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Curator Beastie", 30, Rarity.RARE, mage.cards.c.CuratorBeastie.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Curator Beastie", 58, Rarity.RARE, mage.cards.c.CuratorBeastie.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Deluge of Doom", 18, Rarity.RARE, mage.cards.d.DelugeOfDoom.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Deluge of Doom", 48, Rarity.RARE, mage.cards.d.DelugeOfDoom.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Demolisher Spawn", 31, Rarity.RARE, mage.cards.d.DemolisherSpawn.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Demolisher Spawn", 59, Rarity.RARE, mage.cards.d.DemolisherSpawn.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Demon of Fate's Design", 137, Rarity.RARE, mage.cards.d.DemonOfFatesDesign.class));
        cards.add(new SetCardInfo("Demonic Covenant", 19, Rarity.RARE, mage.cards.d.DemonicCovenant.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Demonic Covenant", 49, Rarity.RARE, mage.cards.d.DemonicCovenant.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Disorienting Choice", 32, Rarity.RARE, mage.cards.d.DisorientingChoice.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Disorienting Choice", 60, Rarity.RARE, mage.cards.d.DisorientingChoice.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Fear of Sleep Paralysis", 12, Rarity.RARE, mage.cards.f.FearOfSleepParalysis.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Fear of Sleep Paralysis", 43, Rarity.RARE, mage.cards.f.FearOfSleepParalysis.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Formless Genesis", 34, Rarity.RARE, mage.cards.f.FormlessGenesis.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Formless Genesis", 61, Rarity.RARE, mage.cards.f.FormlessGenesis.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Giggling Skitterspike", 39, Rarity.RARE, mage.cards.g.GigglingSkitterspike.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Giggling Skitterspike", 66, Rarity.RARE, mage.cards.g.GigglingSkitterspike.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Gleeful Arsonist", 27, Rarity.RARE, mage.cards.g.GleefulArsonist.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Gleeful Arsonist", 56, Rarity.RARE, mage.cards.g.GleefulArsonist.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Glitch Interpreter", 13, Rarity.RARE, mage.cards.g.GlitchInterpreter.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Glitch Interpreter", 44, Rarity.RARE, mage.cards.g.GlitchInterpreter.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Into the Pit", 20, Rarity.RARE, mage.cards.i.IntoThePit.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Into the Pit", 50, Rarity.RARE, mage.cards.i.IntoThePit.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Metamorphosis Fanatic", 21, Rarity.RARE, mage.cards.m.MetamorphosisFanatic.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Metamorphosis Fanatic", 51, Rarity.RARE, mage.cards.m.MetamorphosisFanatic.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Persistent Constrictor", 22, Rarity.RARE, mage.cards.p.PersistentConstrictor.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Redress Fate", 41, Rarity.RARE, mage.cards.r.RedressFate.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Redress Fate", 9, Rarity.RARE, mage.cards.r.RedressFate.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Sadistic Shell Game", 24, Rarity.RARE, mage.cards.s.SadisticShellGame.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Sadistic Shell Game", 53, Rarity.RARE, mage.cards.s.SadisticShellGame.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Shriekwood Devourer", 35, Rarity.RARE, mage.cards.s.ShriekwoodDevourer.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Shriekwood Devourer", 62, Rarity.RARE, mage.cards.s.ShriekwoodDevourer.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Soaring Lightbringer", 11, Rarity.RARE, mage.cards.s.SoaringLightbringer.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Soaring Lightbringer", 42, Rarity.RARE, mage.cards.s.SoaringLightbringer.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Star Athlete", 29, Rarity.RARE, mage.cards.s.StarAthlete.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Star Athlete", 57, Rarity.RARE, mage.cards.s.StarAthlete.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Suspended Sentence", 25, Rarity.RARE, mage.cards.s.SuspendedSentence.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Suspended Sentence", 54, Rarity.RARE, mage.cards.s.SuspendedSentence.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("They Came from the Pipes", 14, Rarity.RARE, mage.cards.t.TheyCameFromThePipes.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("They Came from the Pipes", 45, Rarity.RARE, mage.cards.t.TheyCameFromThePipes.class, NON_FULL_USE_VARIOUS));
