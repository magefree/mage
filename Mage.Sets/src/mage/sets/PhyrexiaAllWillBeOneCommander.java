...
public final class PhyrexiaAllWillBeOneCommander extends ExpansionSet {
    ...
    private PhyrexiaAllWillBeOneCommander() {
        ...
        cards.add(new SetCardInfo("Battle Screech", 59, Rarity.COMMON, mage.cards.b.BattleScreech.class));
        ...
        cards.add(new SetCardInfo("Boros Signet", 126, Rarity.COMMON, mage.cards.b.BorosSignet.class));
        ...
        cards.add(new SetCardInfo("Cut a Deal", 63, Rarity.COMMON, mage.cards.c.CutADeal.class));
        ...
        cards.add(new SetCardInfo("Forgotten Cave", 153, Rarity.COMMON, mage.cards.f.ForgottenCave.class));
        ...
        cards.add(new SetCardInfo("Golgari Signet", 131, Rarity.COMMON, mage.cards.g.GolgariSignet.class));
        ...
        cards.add(new SetCardInfo("Hate Mirage", 99, Rarity.COMMON, mage.cards.h.HateMirage.class));
        cards.add(new SetCardInfo("Heroic Reinforcements", 118, Rarity.UNCOMMON, mage.cards.h.HeroicReinforcements.class));
        cards.add(new SetCardInfo("Hordeling Outburst", 100, Rarity.COMMON, mage.cards.h.HordelingOutburst.class));
        ...
        cards.add(new SetCardInfo("Intangible Virtue", 77, Rarity.COMMON, mage.cards.i.IntangibleVirtue.class));
        ...
        cards.add(new SetCardInfo("Mace of the Valiant", 78, Rarity.COMMON, mage.cards.m.MaceOfTheValiant.class));
        ...
        cards.add(new SetCardInfo("Mentor of the Meek", 81, Rarity.COMMON, mage.cards.m.MentorOfTheMeek.class));
        ...
        cards.add(new SetCardInfo("Mind Stone", 137, Rarity.COMMON, mage.cards.m.MindStone.class));
        ...
        cards.add(new SetCardInfo("Prava of the Steel Legion", 87, Rarity.COMMON, mage.cards.p.PravaOfTheSteelLegion.class));
