...
public final class TarkirDragonstormCommander extends ExpansionSet {
    ...
    private TarkirDragonstormCommander() {
        ...
        cards.add(new SetCardInfo("Transcendent Dragon", 22, Rarity.RARE, mage.cards.t.TranscendentDragon.class));
        ...
        cards.add(new SetCardInfo("Will of the Mardu", 17, Rarity.RARE, mage.cards.w.WillOfTheMardu.class));
