...
public final class IceAge extends ExpansionSet {
    ...
    private IceAge() {
        ...
        cards.add(new SetCardInfo("Orcish Conscripts", 206, Rarity.COMMON, mage.cards.o.OrcishConscripts.class));
        ...
        cards.add(new SetCardInfo("Sacred Boon", 274, Rarity.UNCOMMON, mage.cards.s.SacredBoon.class));
