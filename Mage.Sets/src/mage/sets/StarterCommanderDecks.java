...
public class StarterCommanderDecks extends ExpansionSet {
    ...
    private StarterCommanderDecks() {
        ...
        cards.add(new SetCardInfo("Drakuseth, Maw of Flames", 138, Rarity.RARE, mage.cards.d.Drakuseth,MawOfFlames.class));
        ...
        cards.add(new SetCardInfo("Isperia, Supreme Judge", 4, Rarity.MYTHIC, mage.cards.i.Isperia,SupremeJudge.class));
        ...
        cards.add(new SetCardInfo("Josu Vess, Lich Knight", 82, Rarity.RARE, mage.cards.j.JosuVess,LichKnight.class));
        ...
        cards.add(new SetCardInfo("Kangee, Sky Warden", 234, Rarity.UNCOMMON, mage.cards.k.Kangee,SkyWarden.class));
