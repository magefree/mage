...
public final class TheLostCavernsOfIxalanCommander extends ExpansionSet {
    ...
    private TheLostCavernsOfIxalanCommander() {
        ...
        cards.add(new SetCardInfo("Admiral Brass, Unsinkable", 1, Rarity.MYTHIC, mage.cards.a.AdmiralBrassUnsinkable.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Admiral Brass, Unsinkable", 17, Rarity.MYTHIC, mage.cards.a.AdmiralBrassUnsinkable.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Admiral Brass, Unsinkable", 25, Rarity.MYTHIC, mage.cards.a.AdmiralBrassUnsinkable.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Admiral Brass, Unsinkable", 121, Rarity.MYTHIC, mage.cards.a.AdmiralBrassUnsinkable.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Altar of the Wretched", 10, Rarity.RARE, mage.cards.a.AltarOfTheWretched.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Altar of the Wretched", 22, Rarity.RARE, mage.cards.a.AltarOfTheWretched.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Arcane Signet", 104, Rarity.UNCOMMON, mage.cards.a.ArcaneSignet.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Arcane Signet", 299, Rarity.COMMON, mage.cards.a.ArcaneSignet.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Arm-Mounted Anchor", 67, Rarity.RARE, mage.cards.a.ArmMountedAnchor.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Arm-Mounted Anchor", 99, Rarity.RARE, mage.cards.a.ArmMountedAnchor.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Broadside Bombardiers", 54, Rarity.RARE, mage.cards.b.BroadsideBombardiers.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Broadside Bombardiers", 86, Rarity.RARE, mage.cards.b.BroadsideBombardiers.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Bronzebeak Foragers", 37, Rarity.RARE, mage.cards.b.BronzebeakForagers.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Bronzebeak Foragers", 69, Rarity.RARE, mage.cards.b.BronzebeakForagers.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Butcher of Malakir", 187, Rarity.RARE, mage.cards.b.ButcherOfMalakir.class));
        cards.add(new SetCardInfo("Bygone Marvels", 57, Rarity.RARE, mage.cards.b.BygoneMarvels.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Bygone Marvels", 89, Rarity.RARE, mage.cards.b.BygoneMarvels.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Carmen, Cruel Skymarcher", 5, Rarity.MYTHIC, mage.cards.c.CarmenCruelSkymarcher.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Carmen, Cruel Skymarcher", 26, Rarity.MYTHIC, mage.cards.c.CarmenCruelSkymarcher.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Charismatic Conqueror", 38, Rarity.RARE, mage.cards.c.CharismaticConqueror.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Charismatic Conqueror", 70, Rarity.RARE, mage.cards.c.CharismaticConqueror.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Clavileno, First of the Blessed", 2, Rarity.MYTHIC, mage.cards.c.ClavilenoFirstOfTheBlessed.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Clavileno, First of the Blessed", 18, Rarity.MYTHIC, mage.cards.c.ClavilenoFirstOfTheBlessed.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Clavileno, First of the Blessed", 27, Rarity.MYTHIC, mage.cards.c.ClavilenoFirstOfTheBlessed.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Clavileno, First of the Blessed", 122, Rarity.MYTHIC, mage.cards.c.ClavilenoFirstOfTheBlessed.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Contest of Claws", 12, Rarity.RARE, mage.cards.c.ContestOfClaws.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Contest of Claws", 24, Rarity.RARE, mage.cards.c.ContestOfClaws.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Curious Altisaur", 58, Rarity.RARE, mage.cards.c.CuriousAltisaur.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Curious Altisaur", 90, Rarity.RARE, mage.cards.c.CuriousAltisaur.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Deeproot Historian", 59, Rarity.RARE, mage.cards.d.DeeprootHistorian.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Deeproot Historian", 91, Rarity.RARE, mage.cards.d.DeeprootHistorian.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Dinosaur Egg", 60, Rarity.RARE, mage.cards.d.DinosaurEgg.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Dinosaur Egg", 92, Rarity.RARE, mage.cards.d.DinosaurEgg.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Don Andres, the Renegade", 6, Rarity.MYTHIC, mage.cards.d.DonAndresTheRenegade.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Don Andres, the Renegade", 28, Rarity.MYTHIC, mage.cards.d.DonAndresTheRenegade.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Dusk Legion Sergeant", 48, Rarity.RARE, mage.cards.d.DuskLegionSergeant.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Dusk Legion Sergeant", 80, Rarity.RARE, mage.cards.d.DuskLegionSergeant.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Dusk Legion Zealot", 194, Rarity.COMMON, mage.cards.d.DuskLegionZealot.class));
        cards.add(new SetCardInfo("Elenda's Hierophant", 39, Rarity.RARE, mage.cards.e.ElendasHierophant.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Elenda's Hierophant", 71, Rarity.RARE, mage.cards.e.ElendasHierophant.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Eye of Ojer Taq", 15, Rarity.MYTHIC, mage.cards.e.EyeOfOjerTaq.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Eye of Ojer Taq", 35, Rarity.MYTHIC, mage.cards.e.EyeOfOjerTaq.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Francisco, Fowl Marauder", 49, Rarity.RARE, mage.cards.f.FranciscoFowlMarauder.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Francisco, Fowl Marauder", 81, Rarity.RARE, mage.cards.f.FranciscoFowlMarauder.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("From the Rubble", 40, Rarity.RARE, mage.cards.f.FromTheRubble.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("From the Rubble", 72, Rarity.RARE, mage.cards.f.FromTheRubble.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Gemcutter Buccaneer", 55, Rarity.RARE, mage.cards.g.GemcutterBuccaneer.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Gemcutter Buccaneer", 87, Rarity.RARE, mage.cards.g.GemcutterBuccaneer.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Hakbal of the Surging Soul", 3, Rarity.MYTHIC, mage.cards.h.HakbalOfTheSurgingSoul.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Hakbal of the Surging Soul", 19, Rarity.MYTHIC, mage.cards.h.HakbalOfTheSurgingSoul.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Hakbal of the Surging Soul", 29, Rarity.MYTHIC, mage.cards.h.HakbalOfTheSurgingSoul.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Hakbal of the Surging Soul", 123, Rarity.MYTHIC, mage.cards.h.HakbalOfTheSurgingSoul.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Illustrious Wanderglyph", 9, Rarity.RARE, mage.cards.i.IllustriousWanderglyph.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Illustrious Wanderglyph", 21, Rarity.RARE, mage.cards.i.IllustriousWanderglyph.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("March of the Canonized", 41, Rarity.RARE, mage.cards.m.MarchOfTheCanonized.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("March of the Canonized", 73, Rarity.RARE, mage.cards.m.MarchOfTheCanonized.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Martyr of Dusk", 132, Rarity.COMMON, mage.cards.m.MartyrOfDusk.class));
        cards.add(new SetCardInfo("Master of Dark Rites", 51, Rarity.RARE, mage.cards.m.MasterOfDarkRites.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Master of Dark Rites", 83, Rarity.RARE, mage.cards.m.MasterOfDarkRites.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Mist Dancer", 44, Rarity.RARE, mage.cards.m.MistDancer.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Mist Dancer", 76, Rarity.RARE, mage.cards.m.MistDancer.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Ore-Rich Stalactite", 11, Rarity.RARE, mage.cards.o.OreRichStalactite.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Ore-Rich Stalactite", 23, Rarity.RARE, mage.cards.o.OreRichStalactite.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Order of Sacred Dusk", 65, Rarity.RARE, mage.cards.o.OrderOfSacredDusk.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Order of Sacred Dusk", 97, Rarity.RARE, mage.cards.o.OrderOfSacredDusk.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Paleontologist's Pick-Axe", 16, Rarity.MYTHIC, mage.cards.p.PaleontologistsPickAxe.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Paleontologist's Pick-Axe", 36, Rarity.MYTHIC, mage.cards.p.PaleontologistsPickAxe.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Pantlaza, Sun-Favored", 4, Rarity.MYTHIC, mage.cards.p.PantlazaSunFavored.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Pantlaza, Sun-Favored", 20, Rarity.MYTHIC, mage.cards.p.PantlazaSunFavored.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Pantlaza, Sun-Favored", 30, Rarity.MYTHIC, mage.cards.p.PantlazaSunFavored.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Pantlaza, Sun-Favored", 124, Rarity.MYTHIC, mage.cards.p.PantlazaSunFavored.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Progenitor's Icon", 68, Rarity.RARE, mage.cards.p.ProgenitorsIcon.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Progenitor's Icon", 100, Rarity.RARE, mage.cards.p.ProgenitorsIcon.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Promise of Aclazotz", 52, Rarity.RARE, mage.cards.p.PromiseOfAclazotz.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Promise of Aclazotz", 84, Rarity.RARE, mage.cards.p.PromiseOfAclazotz.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Redemption Choir", 42, Rarity.RARE, mage.cards.r.RedemptionChoir.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Redemption Choir", 74, Rarity.RARE, mage.cards.r.RedemptionChoir.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Ripples of Potential", 45, Rarity.RARE, mage.cards.r.RipplesOfPotential.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Ripples of Potential", 77, Rarity.RARE, mage.cards.r.RipplesOfPotential.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Scion of Calamity", 61, Rarity.RARE, mage.cards.s.ScionOfCalamity.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Scion of Calamity", 93, Rarity.RARE, mage.cards.s.ScionOfCalamity.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Singer of Swift Rivers", 66, Rarity.RARE, mage.cards.s.SingerOfSwiftRivers.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Singer of Swift Rivers", 98, Rarity.RARE, mage.cards.s.SingerOfSwiftRivers.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Siren Stormtamer", 171, Rarity.UNCOMMON, mage.cards.s.SirenStormtamer.class));
        cards.add(new SetCardInfo("Skeleton Crew", 53, Rarity.RARE, mage.cards.s.SkeletonCrew.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Skeleton Crew", 85, Rarity.RARE, mage.cards.s.SkeletonCrew.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Storm Fleet Negotiator", 46, Rarity.RARE, mage.cards.s.StormFleetNegotiator.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Storm Fleet Negotiator", 78, Rarity.RARE, mage.cards.s.StormFleetNegotiator.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Sunfrill Imitator", 62, Rarity.RARE, mage.cards.s.SunfrillImitator.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Sunfrill Imitator", 94, Rarity.RARE, mage.cards.s.SunfrillImitator.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Tetzin, Gnome Champion", 13, Rarity.RARE, mage.cards.t.TetzinGnomeChampion.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Tetzin, Gnome Champion", 31, Rarity.RARE, mage.cards.t.TetzinGnomeChampion.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Thassa, God of the Sea", 176, Rarity.MYTHIC, mage.cards.t.ThassaGodOfTheSea.class));
        cards.add(new SetCardInfo("The Grim Captain's Locker", 50, Rarity.RARE, mage.cards.t.TheGrimCaptainsLocker.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("The Grim Captain's Locker", 82, Rarity.RARE, mage.cards.t.TheGrimCaptainsLocker.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Topography Tracker", 63, Rarity.RARE, mage.cards.t.TopographyTracker.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Topography Tracker", 95, Rarity.RARE, mage.cards.t.TopographyTracker.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Tributary Instructor", 64, Rarity.RARE, mage.cards.t.TributaryInstructor.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Tributary Instructor", 96, Rarity.RARE, mage.cards.t.TributaryInstructor.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Wave Goodbye", 47, Rarity.RARE, mage.cards.w.WaveGoodbye.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Wave Goodbye", 79, Rarity.RARE, mage.cards.w.WaveGoodbye.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Wayfarer's Bauble", 317, Rarity.COMMON, mage.cards.w.WayfarersBauble.class));
        cards.add(new SetCardInfo("Wayta, Trainer Prodigy", 7, Rarity.MYTHIC, mage.cards.w.WaytaTrainerProdigy.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Wayta, Trainer Prodigy", 32, Rarity.MYTHIC, mage.cards.w.WaytaTrainerProdigy.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Wrathful Raptors", 56, Rarity.RARE, mage.cards.w.WrathfulRaptors.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Wrathful Raptors", 88, Rarity.RARE, mage.cards.w.WrathfulRaptors.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Xavier Sal, Infested Captain", 14, Rarity.RARE, mage.cards.x.XavierSalInfestedCaptain.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Xavier Sal, Infested Captain", 33, Rarity.RARE, mage.cards.x.XavierSalInfestedCaptain.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Xenagos, God of Revels", 295, Rarity.MYTHIC, mage.cards.x.XenagosGodOfRevels.class));
        cards.add(new SetCardInfo("Xolatoyac, the Smiling Flood", 8, Rarity.MYTHIC, mage.cards.x.XolatoyacTheSmilingFlood.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Xolatoyac, the Smiling Flood", 34, Rarity.MYTHIC, mage.cards.x.XolatoyacTheSmilingFlood.class, NON_FULL_USE_VARIOUS));
