...
public class WarOfTheSparkPromos extends ExpansionSet {
    ...
    private WarOfTheSparkPromos() {
        ...
        // Commented cards are Japanese-only printings with a special artwork.
        ...
        cards.add(new SetCardInfo("Blast Zone", "244s", Rarity.RARE, mage.cards.b.BlastZone.class));
        ...
        cards.add(new SetCardInfo("Feather, the Redeemed", "197s", Rarity.RARE, mage.cards.f.FeatherTheRedeemed.class));
        ...
        //cards.add(new SetCardInfo("Nahiri, Storm of Stone", "233s★", Rarity.UNCOMMON, mage.cards.n.NahiriStormOfStone.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Narset's Reversal", "62s", Rarity.RARE, mage.cards.n.NarsetsReversal.class));
        ...
        //cards.add(new SetCardInfo("Sarkhan the Masterless", "143s★", Rarity.RARE, mage.cards.s.SarkhanTheMasterless.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Silent Submersible", "66p", Rarity.RARE, mage.cards.s.SilentSubmersible.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Silent Submersible", "66s", Rarity.RARE, mage.cards.s.SilentSubmersible.class, NON_FULL_USE_VARIOUS));
