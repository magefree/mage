...
public final class FromTheVaultTransform extends ExpansionSet {
    ...
    private FromTheVaultTransform() {
        ...
        cards.add(new SetCardInfo("Bruna, the Fading Light", "5", "5b", Rarity.MYTHIC, mage.cards.b.BrunaTheFadingLight.class));
        ...
        cards.add(new SetCardInfo("Gisela, the Broken Blade", "10", "5b", Rarity.MYTHIC, mage.cards.g.GiselaTheBrokenBlade.class));
