...
public final class Warhammer40000 extends ExpansionSet {
    ...
    private Warhammer40000() {
        ...
        cards.add(new SetCardInfo("Aspiring Champion", 71, Rarity.RARE, mage.cards.a.AspiringChampion.class));
        ...
        cards.add(new SetCardInfo("Helbrute", 125, Rarity.RARE, mage.cards.h.Helbrute.class));
        ...
        cards.add(new SetCardInfo("Redemptor Dreadnought", 164, Rarity.RARE, mage.cards.r.RedemptorDreadnought.class));
        ...
        cards.add(new SetCardInfo("Tzaangor Shaman", 146, Rarity.RARE, mage.cards.t.TzaangorShaman.class));
