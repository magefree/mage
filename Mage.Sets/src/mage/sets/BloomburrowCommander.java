...
public final class BloomburrowCommander extends ExpansionSet {
    ...
    private BloomburrowCommander() {
        ...
        cards.add(new SetCardInfo("Agate Instigator", 21, Rarity.RARE, mage.cards.a.AgateInstigator.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Agate Instigator", 56, Rarity.RARE, mage.cards.a.AgateInstigator.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Arthur, Marigold Knight", 5, Rarity.MYTHIC, mage.cards.a.ArthurMarigoldKnight.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Arthur, Marigold Knight", 41, Rarity.MYTHIC, mage.cards.a.ArthurMarigoldKnight.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Bello, Bard of the Brambles", 1, Rarity.MYTHIC, mage.cards.b.BelloBardOfTheBrambles.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Bello, Bard of the Brambles", 101, Rarity.MYTHIC, mage.cards.b.BelloBardOfTheBrambles.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Bloodroot Apothecary", 27, Rarity.RARE, mage.cards.b.BloodrootApothecary.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Bloodroot Apothecary", 61, Rarity.RARE, mage.cards.b.BloodrootApothecary.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Brightcap Badger", 28, Rarity.RARE, mage.cards.b.BrightcapBadger.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Brightcap Badger", 62, Rarity.RARE, mage.cards.b.BrightcapBadger.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Calamity of Cinders", 23, Rarity.RARE, mage.cards.c.CalamityOfCinders.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Calamity of Cinders", 57, Rarity.RARE, mage.cards.c.CalamityOfCinders.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Chatterfang, Squirrel General", 82, Rarity.MYTHIC, mage.cards.c.ChatterfangSquirrelGeneral.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Chatterfang, Squirrel General", 95, Rarity.MYTHIC, mage.cards.c.ChatterfangSquirrelGeneral.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Chatterfang, Squirrel General", 209, Rarity.MYTHIC, mage.cards.c.ChatterfangSquirrelGeneral.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Echoing Assault", 24, Rarity.RARE, mage.cards.e.EchoingAssault.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Echoing Assault", 58, Rarity.RARE, mage.cards.e.EchoingAssault.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Evercoat Ursine", 30, Rarity.RARE, mage.cards.e.EvercoatUrsine.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Evercoat Ursine", 64, Rarity.RARE, mage.cards.e.EvercoatUrsine.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Gilded Goose", 83, Rarity.RARE, mage.cards.g.GildedGoose.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Gilded Goose", 221, Rarity.RARE, mage.cards.g.GildedGoose.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Hazel of the Rootbloom", 2, Rarity.MYTHIC, mage.cards.h.HazelOfTheRootbloom.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Hazel of the Rootbloom", 102, Rarity.MYTHIC, mage.cards.h.HazelOfTheRootbloom.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Insatiable Frugivore", 18, Rarity.RARE, mage.cards.i.InsatiableFrugivore.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Insatiable Frugivore", 53, Rarity.RARE, mage.cards.i.InsatiableFrugivore.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Jace, the Mind Sculptor", 75, Rarity.MYTHIC, mage.cards.j.JaceTheMindSculptor.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Jace, the Mind Sculptor", 93, Rarity.MYTHIC, mage.cards.j.JaceTheMindSculptor.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Jacked Rabbit", 9, Rarity.RARE, mage.cards.j.JackedRabbit.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Jacked Rabbit", 45, Rarity.RARE, mage.cards.j.JackedRabbit.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Kwain, Itinerant Meddler", 90, Rarity.RARE, mage.cards.k.KwainItinerantMeddler.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Kwain, Itinerant Meddler", 254, Rarity.RARE, mage.cards.k.KwainItinerantMeddler.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Kykar, Wind's Fury", 91, Rarity.MYTHIC, mage.cards.k.KykarWindsFury.class));
        cards.add(new SetCardInfo("Liliana of the Dark Realms", 78, Rarity.MYTHIC, mage.cards.l.LilianaOfTheDarkRealms.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Liliana of the Dark Realms", 94, Rarity.MYTHIC, mage.cards.l.LilianaOfTheDarkRealms.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Luminous Broodmoth", 74, Rarity.MYTHIC, mage.cards.l.LuminousBroodmoth.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Luminous Broodmoth", 144, Rarity.MYTHIC, mage.cards.l.LuminousBroodmoth.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Moonstone Eulogist", 19, Rarity.RARE, mage.cards.m.MoonstoneEulogist.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Moonstone Eulogist", 54, Rarity.RARE, mage.cards.m.MoonstoneEulogist.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Mr. Foxglove", 6, Rarity.MYTHIC, mage.cards.m.MrFoxglove.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Mr. Foxglove", 42, Rarity.MYTHIC, mage.cards.m.MrFoxglove.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Ms. Bumbleflower", 3, Rarity.MYTHIC, mage.cards.m.MsBumbleflower.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Ms. Bumbleflower", 103, Rarity.MYTHIC, mage.cards.m.MsBumbleflower.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Murmuration", 10, Rarity.RARE, mage.cards.m.Murmuration.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Murmuration", 46, Rarity.RARE, mage.cards.m.Murmuration.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Nissa, Who Shakes the World", 84, Rarity.RARE, mage.cards.n.NissaWhoShakesTheWorld.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Nissa, Who Shakes the World", 96, Rarity.RARE, mage.cards.n.NissaWhoShakesTheWorld.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Octomancer", 37, Rarity.RARE, mage.cards.o.Octomancer.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Octomancer", 69, Rarity.RARE, mage.cards.o.Octomancer.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Perch Protection", 11, Rarity.RARE, mage.cards.p.PerchProtection.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Perch Protection", 47, Rarity.RARE, mage.cards.p.PerchProtection.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Pollywog Prodigy", 15, Rarity.RARE, mage.cards.p.PollywogProdigy.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Pollywog Prodigy", 50, Rarity.RARE, mage.cards.p.PollywogProdigy.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Prosperous Bandit", 25, Rarity.RARE, mage.cards.p.ProsperousBandit.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Prosperous Bandit", 59, Rarity.RARE, mage.cards.p.ProsperousBandit.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Pyreswipe Hawk", 26, Rarity.RARE, mage.cards.p.PyreswipeHawk.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Pyreswipe Hawk", 60, Rarity.RARE, mage.cards.p.PyreswipeHawk.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Rapid Augmenter", 38, Rarity.RARE, mage.cards.r.RapidAugmenter.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Rapid Augmenter", 70, Rarity.RARE, mage.cards.r.RapidAugmenter.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Rolling Hamsphere", 39, Rarity.RARE, mage.cards.r.RollingHamsphere.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Rolling Hamsphere", 71, Rarity.RARE, mage.cards.r.RollingHamsphere.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Rootbound Crag", 326, Rarity.RARE, mage.cards.r.RootboundCrag.class));
        cards.add(new SetCardInfo("Rootcast Apprenticeship", 32, Rarity.RARE, mage.cards.r.RootcastApprenticeship.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Rootcast Apprenticeship", 65, Rarity.RARE, mage.cards.r.RootcastApprenticeship.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Scurry of Squirrels", 33, Rarity.RARE, mage.cards.s.ScurryOfSquirrels.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Scurry of Squirrels", 66, Rarity.RARE, mage.cards.s.ScurryOfSquirrels.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Steelburr Champion", 12, Rarity.RARE, mage.cards.s.SteelburrChampion.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Steelburr Champion", 48, Rarity.RARE, mage.cards.s.SteelburrChampion.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Swarmyard Massacre", 20, Rarity.RARE, mage.cards.s.SwarmyardMassacre.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Swarmyard Massacre", 55, Rarity.RARE, mage.cards.s.SwarmyardMassacre.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Swiftfoot Boots", 286, Rarity.UNCOMMON, mage.cards.s.SwiftfootBoots.class));
        cards.add(new SetCardInfo("Sword of the Squeak", 40, Rarity.RARE, mage.cards.s.SwordOfTheSqueak.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Sword of the Squeak", 72, Rarity.RARE, mage.cards.s.SwordOfTheSqueak.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Tempt with Bunnies", 13, Rarity.RARE, mage.cards.t.TemptWithBunnies.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Tempt with Bunnies", 49, Rarity.RARE, mage.cards.t.TemptWithBunnies.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("The Odd Acorn Gang", 7, Rarity.MYTHIC, mage.cards.t.TheOddAcornGang.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("The Odd Acorn Gang", 43, Rarity.MYTHIC, mage.cards.t.TheOddAcornGang.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Trailtracker Scout", 35, Rarity.RARE, mage.cards.t.TrailtrackerScout.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Trailtracker Scout", 68, Rarity.RARE, mage.cards.t.TrailtrackerScout.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Wildsear, Scouring Maw", 8, Rarity.MYTHIC, mage.cards.w.WildsearScouringMaw.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Wildsear, Scouring Maw", 44, Rarity.MYTHIC, mage.cards.w.WildsearScouringMaw.class, NON_FULL_USE_VARIOUS));
