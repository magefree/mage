...
public final class Foundations extends ExpansionSet {
    ...
    private Foundations() {
        ...
        // Play Boosters may contain FDN #1–361. Collector Boosters may contain FDN #1–271, 282–487.
        this.enablePlayBooster(361);

        cards.add(new SetCardInfo("Abrade", 188, Rarity.UNCOMMON, mage.cards.a.Abrade.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Abrade", 327, Rarity.UNCOMMON, mage.cards.a.Abrade.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Abyssal Harvester", 316, Rarity.RARE, mage.cards.a.AbyssalHarvester.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Abyssal Harvester", 381, Rarity.RARE, mage.cards.a.AbyssalHarvester.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Abyssal Harvester", 458, Rarity.RARE, mage.cards.a.AbyssalHarvester.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Abyssal Harvester", 54, Rarity.RARE, mage.cards.a.AbyssalHarvester.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Ajani's Pridemate", 135, Rarity.UNCOMMON, mage.cards.a.AjanisPridemate.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Ajani's Pridemate", 293, Rarity.UNCOMMON, mage.cards.a.AjanisPridemate.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Ajani, Caller of the Pride", 134, Rarity.MYTHIC, mage.cards.a.AjaniCallerOfThePride.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Ajani, Caller of the Pride", 357, Rarity.MYTHIC, mage.cards.a.AjaniCallerOfThePride.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Ajani, Caller of the Pride", 417, Rarity.MYTHIC, mage.cards.a.AjaniCallerOfThePride.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Alesha, Who Laughs at Fate", 115, Rarity.RARE, mage.cards.a.AleshaWhoLaughsAtFate.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Alesha, Who Laughs at Fate", 343, Rarity.RARE, mage.cards.a.AleshaWhoLaughsAtFate.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Alesha, Who Laughs at Fate", 404, Rarity.RARE, mage.cards.a.AleshaWhoLaughsAtFate.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Alesha, Who Laughs at Fate", 476, Rarity.RARE, mage.cards.a.AleshaWhoLaughsAtFate.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Arahbo, the First Fang", 294, Rarity.RARE, mage.cards.a.ArahboTheFirstFang.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Arahbo, the First Fang", 363, Rarity.RARE, mage.cards.a.ArahboTheFirstFang.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Arahbo, the First Fang", 442, Rarity.RARE, mage.cards.a.ArahboTheFirstFang.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Arcanis the Omnipotent", 585, Rarity.RARE, mage.cards.a.ArcanisTheOmnipotent.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Arcanis the Omnipotent", 741, Rarity.RARE, mage.cards.a.ArcanisTheOmnipotent.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Archmage of Runes", 30, Rarity.RARE, mage.cards.a.ArchmageOfRunes.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Archmage of Runes", 304, Rarity.RARE, mage.cards.a.ArchmageOfRunes.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Archmage of Runes", 372, Rarity.RARE, mage.cards.a.ArchmageOfRunes.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Archmage of Runes", 450, Rarity.RARE, mage.cards.a.ArchmageOfRunes.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Ashroot Animist", 117, Rarity.RARE, mage.cards.a.AshrootAnimist.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Ashroot Animist", 345, Rarity.RARE, mage.cards.a.AshrootAnimist.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Ashroot Animist", 406, Rarity.RARE, mage.cards.a.AshrootAnimist.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Ashroot Animist", 478, Rarity.RARE, mage.cards.a.AshrootAnimist.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Banner of Kinship", 413, Rarity.RARE, mage.cards.b.BannerOfKinship.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Blasphemous Edict", 317, Rarity.RARE, mage.cards.b.BlasphemousEdict.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Blasphemous Edict", 382, Rarity.RARE, mage.cards.b.BlasphemousEdict.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Blasphemous Edict", 459, Rarity.RARE, mage.cards.b.BlasphemousEdict.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Blasphemous Edict", 57, Rarity.RARE, mage.cards.b.BlasphemousEdict.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Bloodfell Caves", 259, Rarity.COMMON, mage.cards.b.BloodfellCaves.class));
        cards.add(new SetCardInfo("Bloodthirsty Conqueror", 318, Rarity.MYTHIC, mage.cards.b.BloodthirstyConqueror.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Bloodthirsty Conqueror", 383, Rarity.MYTHIC, mage.cards.b.BloodthirstyConqueror.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Bloodthirsty Conqueror", 426, Rarity.MYTHIC, mage.cards.b.BloodthirstyConqueror.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Bloodthirsty Conqueror", 436, Rarity.MYTHIC, mage.cards.b.BloodthirstyConqueror.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Bloodthirsty Conqueror", 460, Rarity.MYTHIC, mage.cards.b.BloodthirstyConqueror.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Bloodthirsty Conqueror", 58, Rarity.MYTHIC, mage.cards.b.BloodthirstyConqueror.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Bloodtithe Collector", 516, Rarity.UNCOMMON, mage.cards.b.BloodtitheCollector.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Bloodtithe Collector", 751, Rarity.UNCOMMON, mage.cards.b.BloodtitheCollector.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Carnelian Orb of Dragonkind", 534, Rarity.COMMON, mage.cards.c.CarnelianOrbOfDragonkind.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Carnelian Orb of Dragonkind", 759, Rarity.COMMON, mage.cards.c.CarnelianOrbOfDragonkind.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Celestial Armor", 295, Rarity.RARE, mage.cards.c.CelestialArmor.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Celestial Armor", 364, Rarity.RARE, mage.cards.c.CelestialArmor.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Celestial Armor", 443, Rarity.RARE, mage.cards.c.CelestialArmor.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Celestial Armor", 5, Rarity.RARE, mage.cards.c.CelestialArmor.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Chandra, Flameshaper", 360, Rarity.MYTHIC, mage.cards.c.ChandraFlameshaper.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Chandra, Flameshaper", 420, Rarity.MYTHIC, mage.cards.c.ChandraFlameshaper.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Chandra, Flameshaper", 81, Rarity.MYTHIC, mage.cards.c.ChandraFlameshaper.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Crusader of Odric", 569, Rarity.COMMON, mage.cards.c.CrusaderOfOdric.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Crusader of Odric", 731, Rarity.COMMON, mage.cards.c.CrusaderOfOdric.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Crypt Feaster", 59, Rarity.COMMON, mage.cards.c.CryptFeaster.class));
        cards.add(new SetCardInfo("Cryptic Caves", 686, Rarity.UNCOMMON, mage.cards.c.CrypticCaves.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Cryptic Caves", 771, Rarity.UNCOMMON, mage.cards.c.CrypticCaves.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Crystal Barricade", 296, Rarity.RARE, mage.cards.c.CrystalBarricade.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Crystal Barricade", 365, Rarity.RARE, mage.cards.c.CrystalBarricade.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Crystal Barricade", 444, Rarity.RARE, mage.cards.c.CrystalBarricade.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Crystal Barricade", 7, Rarity.RARE, mage.cards.c.CrystalBarricade.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Cultivator's Caravan", 670, Rarity.RARE, mage.cards.c.CultivatorsCaravan.class));
        cards.add(new SetCardInfo("Curator of Destinies", 305, Rarity.RARE, mage.cards.c.CuratorOfDestinies.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Curator of Destinies", 34, Rarity.RARE, mage.cards.c.CuratorOfDestinies.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Curator of Destinies", 373, Rarity.RARE, mage.cards.c.CuratorOfDestinies.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Curator of Destinies", 451, Rarity.RARE, mage.cards.c.CuratorOfDestinies.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Day of Judgment", 140, Rarity.RARE, mage.cards.d.DayOfJudgment.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Day of Judgment", 422, Rarity.MYTHIC, mage.cards.d.DayOfJudgment.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Day of Judgment", 432, Rarity.MYTHIC, mage.cards.d.DayOfJudgment.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Dazzling Angel", 732, Rarity.COMMON, mage.cards.d.DazzlingAngel.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Dazzling Angel", 9, Rarity.COMMON, mage.cards.d.DazzlingAngel.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Diamond Mare", 672, Rarity.UNCOMMON, mage.cards.d.DiamondMare.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Diamond Mare", 770, Rarity.UNCOMMON, mage.cards.d.DiamondMare.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Doubling Season", 216, Rarity.MYTHIC, mage.cards.d.DoublingSeason.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Doubling Season", 428, Rarity.MYTHIC, mage.cards.d.DoublingSeason.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Doubling Season", 438, Rarity.MYTHIC, mage.cards.d.DoublingSeason.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Drake Hatcher", 306, Rarity.RARE, mage.cards.d.DrakeHatcher.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Drake Hatcher", 35, Rarity.RARE, mage.cards.d.DrakeHatcher.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Drake Hatcher", 374, Rarity.RARE, mage.cards.d.DrakeHatcher.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Drake Hatcher", 452, Rarity.RARE, mage.cards.d.DrakeHatcher.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Drakuseth, Maw of Flames", 193, Rarity.RARE, mage.cards.d.DrakusethMawOfFlames.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Drakuseth, Maw of Flames", 760, Rarity.RARE, mage.cards.d.DrakusethMawOfFlames.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Electroduplicate", 328, Rarity.RARE, mage.cards.e.Electroduplicate.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Electroduplicate", 390, Rarity.RARE, mage.cards.e.Electroduplicate.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Electroduplicate", 465, Rarity.RARE, mage.cards.e.Electroduplicate.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Electroduplicate", 85, Rarity.RARE, mage.cards.e.Electroduplicate.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Elementalist Adept", 36, Rarity.COMMON, mage.cards.e.ElementalistAdept.class));
        cards.add(new SetCardInfo("Elenda, Saint of Dusk", 119, Rarity.RARE, mage.cards.e.ElendaSaintOfDusk.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Elenda, Saint of Dusk", 346, Rarity.RARE, mage.cards.e.ElendaSaintOfDusk.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Elenda, Saint of Dusk", 407, Rarity.RARE, mage.cards.e.ElendaSaintOfDusk.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Elenda, Saint of Dusk", 479, Rarity.RARE, mage.cards.e.ElendaSaintOfDusk.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Etali, Primal Storm", 194, Rarity.RARE, mage.cards.e.EtaliPrimalStorm.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Etali, Primal Storm", 329, Rarity.RARE, mage.cards.e.EtaliPrimalStorm.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Etali, Primal Storm", 391, Rarity.RARE, mage.cards.e.EtaliPrimalStorm.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Exemplar of Light", 11, Rarity.RARE, mage.cards.e.ExemplarOfLight.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Exemplar of Light", 297, Rarity.RARE, mage.cards.e.ExemplarOfLight.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Exemplar of Light", 366, Rarity.RARE, mage.cards.e.ExemplarOfLight.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Exemplar of Light", 445, Rarity.RARE, mage.cards.e.ExemplarOfLight.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Exemplar of Light", 733, Rarity.RARE, mage.cards.e.ExemplarOfLight.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Firespitter Whelp", 197, Rarity.UNCOMMON, mage.cards.f.FirespitterWhelp.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Firespitter Whelp", 761, Rarity.UNCOMMON, mage.cards.f.FirespitterWhelp.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Forest", 290, Rarity.LAND, mage.cards.basiclands.Forest.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Forest", 291, Rarity.LAND, mage.cards.basiclands.Forest.class, FULL_ART_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Gatekeeper of Malakir", 713, Rarity.UNCOMMON, mage.cards.g.GatekeeperOfMalakir.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Gatekeeper of Malakir", 752, Rarity.UNCOMMON, mage.cards.g.GatekeeperOfMalakir.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Gateway Sneak", 592, Rarity.UNCOMMON, mage.cards.g.GatewaySneak.class));
        cards.add(new SetCardInfo("Genesis Wave", 221, Rarity.RARE, mage.cards.g.GenesisWave.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Genesis Wave", 334, Rarity.RARE, mage.cards.g.GenesisWave.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Genesis Wave", 396, Rarity.RARE, mage.cards.g.GenesisWave.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Ghalta, Primal Hunger", 222, Rarity.RARE, mage.cards.g.GhaltaPrimalHunger.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Ghalta, Primal Hunger", 335, Rarity.RARE, mage.cards.g.GhaltaPrimalHunger.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Ghalta, Primal Hunger", 397, Rarity.RARE, mage.cards.g.GhaltaPrimalHunger.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Ghitu Lavarunner", 623, Rarity.COMMON, mage.cards.g.GhituLavarunner.class));
        cards.add(new SetCardInfo("Giada, Font of Hope", 141, Rarity.RARE, mage.cards.g.GiadaFontOfHope.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Giada, Font of Hope", 298, Rarity.RARE, mage.cards.g.GiadaFontOfHope.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Giada, Font of Hope", 367, Rarity.RARE, mage.cards.g.GiadaFontOfHope.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Gigantosaurus", 718, Rarity.RARE, mage.cards.g.Gigantosaurus.class, FULL_ART));
        ...
        cards.add(new SetCardInfo("Healer's Hawk", 142, Rarity.COMMON, mage.cards.h.HealersHawk.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Healer's Hawk", 734, Rarity.COMMON, mage.cards.h.HealersHawk.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Herald of Eternal Dawn", 17, Rarity.MYTHIC, mage.cards.h.HeraldOfEternalDawn.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Herald of Eternal Dawn", 299, Rarity.MYTHIC, mage.cards.h.HeraldOfEternalDawn.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Herald of Eternal Dawn", 368, Rarity.MYTHIC, mage.cards.h.HeraldOfEternalDawn.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Herald of Eternal Dawn", 423, Rarity.MYTHIC, mage.cards.h.HeraldOfEternalDawn.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Herald of Eternal Dawn", 433, Rarity.MYTHIC, mage.cards.h.HeraldOfEternalDawn.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Herald of Eternal Dawn", 446, Rarity.MYTHIC, mage.cards.h.HeraldOfEternalDawn.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Herald of Faith", 494, Rarity.UNCOMMON, mage.cards.h.HeraldOfFaith.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Herald of Faith", 735, Rarity.UNCOMMON, mage.cards.h.HeraldOfFaith.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("High Fae Trickster", 307, Rarity.RARE, mage.cards.h.HighFaeTrickster.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("High Fae Trickster", 375, Rarity.RARE, mage.cards.h.HighFaeTrickster.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("High Fae Trickster", 40, Rarity.RARE, mage.cards.h.HighFaeTrickster.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("High Fae Trickster", 453, Rarity.RARE, mage.cards.h.HighFaeTrickster.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("High-Society Hunter", 320, Rarity.RARE, mage.cards.h.HighSocietyHunter.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("High-Society Hunter", 384, Rarity.RARE, mage.cards.h.HighSocietyHunter.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("High-Society Hunter", 461, Rarity.RARE, mage.cards.h.HighSocietyHunter.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("High-Society Hunter", 61, Rarity.RARE, mage.cards.h.HighSocietyHunter.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Homunculus Horde", 308, Rarity.RARE, mage.cards.h.HomunculusHorde.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Homunculus Horde", 376, Rarity.RARE, mage.cards.h.HomunculusHorde.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Homunculus Horde", 41, Rarity.RARE, mage.cards.h.HomunculusHorde.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Homunculus Horde", 454, Rarity.RARE, mage.cards.h.HomunculusHorde.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Hungry Ghoul", 62, Rarity.COMMON, mage.cards.h.HungryGhoul.class));
        cards.add(new SetCardInfo("Icewind Elemental", 42, Rarity.COMMON, mage.cards.i.IcewindElemental.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Icewind Elemental", 742, Rarity.COMMON, mage.cards.i.IcewindElemental.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Inspiring Overseer", 496, Rarity.COMMON, mage.cards.i.InspiringOverseer.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Inspiring Overseer", 736, Rarity.COMMON, mage.cards.i.InspiringOverseer.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Island", 284, Rarity.LAND, mage.cards.basiclands.Island.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Island", 285, Rarity.LAND, mage.cards.basiclands.Island.class, FULL_ART_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Kaito, Cunning Infiltrator", 358, Rarity.MYTHIC, mage.cards.k.KaitoCunningInfiltrator.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Kaito, Cunning Infiltrator", 418, Rarity.MYTHIC, mage.cards.k.KaitoCunningInfiltrator.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Kaito, Cunning Infiltrator", 424, Rarity.MYTHIC, mage.cards.k.KaitoCunningInfiltrator.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Kaito, Cunning Infiltrator", 434, Rarity.MYTHIC, mage.cards.k.KaitoCunningInfiltrator.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Kaito, Cunning Infiltrator", 44, Rarity.MYTHIC, mage.cards.k.KaitoCunningInfiltrator.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Kalastria Highborn", 607, Rarity.RARE, mage.cards.k.KalastriaHighborn.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Kalastria Highborn", 753, Rarity.RARE, mage.cards.k.KalastriaHighborn.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Kargan Dragonrider", 541, Rarity.COMMON, mage.cards.k.KarganDragonrider.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Kargan Dragonrider", 762, Rarity.COMMON, mage.cards.k.KarganDragonrider.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Kellan, Planar Trailblazer", 330, Rarity.RARE, mage.cards.k.KellanPlanarTrailblazer.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Kellan, Planar Trailblazer", 392, Rarity.RARE, mage.cards.k.KellanPlanarTrailblazer.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Kellan, Planar Trailblazer", 466, Rarity.RARE, mage.cards.k.KellanPlanarTrailblazer.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Kellan, Planar Trailblazer", 91, Rarity.RARE, mage.cards.k.KellanPlanarTrailblazer.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Kindled Fury", 542, Rarity.COMMON, mage.cards.k.KindledFury.class));
        cards.add(new SetCardInfo("Kiora, the Rising Tide", 309, Rarity.RARE, mage.cards.k.KioraTheRisingTide.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Kiora, the Rising Tide", 377, Rarity.RARE, mage.cards.k.KioraTheRisingTide.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Kiora, the Rising Tide", 45, Rarity.RARE, mage.cards.k.KioraTheRisingTide.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Kiora, the Rising Tide", 455, Rarity.RARE, mage.cards.k.KioraTheRisingTide.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Kitesail Corsair", 510, Rarity.COMMON, mage.cards.k.KitesailCorsair.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Kitesail Corsair", 743, Rarity.COMMON, mage.cards.k.KitesailCorsair.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Koma, World-Eater", 121, Rarity.RARE, mage.cards.k.KomaWorldEater.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Koma, World-Eater", 347, Rarity.RARE, mage.cards.k.KomaWorldEater.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Koma, World-Eater", 408, Rarity.RARE, mage.cards.k.KomaWorldEater.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Lathril, Blade of the Elves", 242, Rarity.RARE, mage.cards.l.LathrilBladeOfTheElves.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Lathril, Blade of the Elves", 349, Rarity.RARE, mage.cards.l.LathrilBladeOfTheElves.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Lathril, Blade of the Elves", 410, Rarity.RARE, mage.cards.l.LathrilBladeOfTheElves.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Leyline Axe", 129, Rarity.RARE, mage.cards.l.LeylineAxe.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Leyline Axe", 353, Rarity.RARE, mage.cards.l.LeylineAxe.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Leyline Axe", 414, Rarity.RARE, mage.cards.l.LeylineAxe.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Leyline Axe", 485, Rarity.RARE, mage.cards.l.LeylineAxe.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Lightshell Duo", 157, Rarity.COMMON, mage.cards.l.LightshellDuo.class));
        cards.add(new SetCardInfo("Liliana, Dreadhorde General", 176, Rarity.MYTHIC, mage.cards.l.LilianaDreadhordeGeneral.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Liliana, Dreadhorde General", 359, Rarity.MYTHIC, mage.cards.l.LilianaDreadhordeGeneral.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Liliana, Dreadhorde General", 419, Rarity.MYTHIC, mage.cards.l.LilianaDreadhordeGeneral.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Linden, the Steadfast Queen", 577, Rarity.RARE, mage.cards.l.LindenTheSteadfastQueen.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Linden, the Steadfast Queen", 737, Rarity.RARE, mage.cards.l.LindenTheSteadfastQueen.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Llanowar Elves", 227, Rarity.COMMON, mage.cards.l.LlanowarElves.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Llanowar Elves", 429, Rarity.MYTHIC, mage.cards.l.LlanowarElves.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Llanowar Elves", 439, Rarity.MYTHIC, mage.cards.l.LlanowarElves.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Loot, Exuberant Explorer", 106, Rarity.RARE, mage.cards.l.LootExuberantExplorer.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Loot, Exuberant Explorer", 336, Rarity.RARE, mage.cards.l.LootExuberantExplorer.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Loot, Exuberant Explorer", 398, Rarity.RARE, mage.cards.l.LootExuberantExplorer.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Loot, Exuberant Explorer", 470, Rarity.RARE, mage.cards.l.LootExuberantExplorer.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Luminous Rebuke", 20, Rarity.COMMON, mage.cards.l.LuminousRebuke.class));
        cards.add(new SetCardInfo("Lunar Insight", 310, Rarity.RARE, mage.cards.l.LunarInsight.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Lunar Insight", 378, Rarity.RARE, mage.cards.l.LunarInsight.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Lunar Insight", 456, Rarity.RARE, mage.cards.l.LunarInsight.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Lunar Insight", 46, Rarity.RARE, mage.cards.l.LunarInsight.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Lyra Dawnbringer", 707, Rarity.MYTHIC, mage.cards.l.LyraDawnbringer.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Lyra Dawnbringer", 738, Rarity.MYTHIC, mage.cards.l.LyraDawnbringer.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Massacre Wurm", 714, Rarity.MYTHIC, mage.cards.m.MassacreWurm.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Massacre Wurm", 754, Rarity.MYTHIC, mage.cards.m.MassacreWurm.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Mocking Sprite", 159, Rarity.COMMON, mage.cards.m.MockingSprite.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Mocking Sprite", 744, Rarity.COMMON, mage.cards.m.MockingSprite.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Mossborn Hydra", 107, Rarity.RARE, mage.cards.m.MossbornHydra.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Mossborn Hydra", 337, Rarity.RARE, mage.cards.m.MossbornHydra.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Mossborn Hydra", 399, Rarity.RARE, mage.cards.m.MossbornHydra.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Mossborn Hydra", 471, Rarity.RARE, mage.cards.m.MossbornHydra.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Mountain", 288, Rarity.LAND, mage.cards.basiclands.Mountain.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Mountain", 289, Rarity.LAND, mage.cards.basiclands.Mountain.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Muldrotha, the Gravetide", 243, Rarity.MYTHIC, mage.cards.m.MuldrothaTheGravetide.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Muldrotha, the Gravetide", 430, Rarity.MYTHIC, mage.cards.m.MuldrothaTheGravetide.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Muldrotha, the Gravetide", 440, Rarity.MYTHIC, mage.cards.m.MuldrothaTheGravetide.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Niv-Mizzet, Visionary", 350, Rarity.MYTHIC, mage.cards.n.NivMizzetVisionary.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Niv-Mizzet, Visionary", 411, Rarity.MYTHIC, mage.cards.n.NivMizzetVisionary.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Niv-Mizzet, Visionary", 482, Rarity.MYTHIC, mage.cards.n.NivMizzetVisionary.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Pelakka Wurm", 720, Rarity.UNCOMMON, mage.cards.p.PelakkaWurm.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Pelakka Wurm", 765, Rarity.UNCOMMON, mage.cards.p.PelakkaWurm.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Perforating Artist", 124, Rarity.UNCOMMON, mage.cards.p.PerforatingArtist.class));
        cards.add(new SetCardInfo("Phyrexian Arena", 180, Rarity.RARE, mage.cards.p.PhyrexianArena.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Phyrexian Arena", 322, Rarity.RARE, mage.cards.p.PhyrexianArena.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Phyrexian Arena", 386, Rarity.RARE, mage.cards.p.PhyrexianArena.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Phyrexian Arena", 728, Rarity.RARE, mage.cards.p.PhyrexianArena.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Plains", 282, Rarity.LAND, mage.cards.basiclands.Plains.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Plains", 283, Rarity.LAND, mage.cards.basiclands.Plains.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Prayer of Binding", 502, Rarity.UNCOMMON, mage.cards.p.PrayerOfBinding.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Prayer of Binding", 739, Rarity.UNCOMMON, mage.cards.p.PrayerOfBinding.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Predator Ooze", 642, Rarity.RARE, mage.cards.p.PredatorOoze.class));
        cards.add(new SetCardInfo("Preposterous Proportions", 109, Rarity.RARE, mage.cards.p.PreposterousProportions.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Preposterous Proportions", 338, Rarity.RARE, mage.cards.p.PreposterousProportions.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Preposterous Proportions", 400, Rarity.RARE, mage.cards.p.PreposterousProportions.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Preposterous Proportions", 472, Rarity.RARE, mage.cards.p.PreposterousProportions.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Prideful Parent", 21, Rarity.COMMON, mage.cards.p.PridefulParent.class));
        cards.add(new SetCardInfo("Primal Might", 643, Rarity.RARE, mage.cards.p.PrimalMight.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Primal Might", 766, Rarity.RARE, mage.cards.p.PrimalMight.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Progenitus", 244, Rarity.MYTHIC, mage.cards.p.Progenitus.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Progenitus", 431, Rarity.MYTHIC, mage.cards.p.Progenitus.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Progenitus", 441, Rarity.MYTHIC, mage.cards.p.Progenitus.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Pulse Tracker", 612, Rarity.COMMON, mage.cards.p.PulseTracker.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Pulse Tracker", 755, Rarity.COMMON, mage.cards.p.PulseTracker.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Quilled Greatwurm", 401, Rarity.MYTHIC, mage.cards.q.QuilledGreatwurm.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Raise the Past", 22, Rarity.RARE, mage.cards.r.RaiseThePast.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Raise the Past", 300, Rarity.RARE, mage.cards.r.RaiseThePast.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Raise the Past", 369, Rarity.RARE, mage.cards.r.RaiseThePast.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Raise the Past", 447, Rarity.RARE, mage.cards.r.RaiseThePast.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Rise of the Dark Realms", 183, Rarity.MYTHIC, mage.cards.r.RiseOfTheDarkRealms.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Rise of the Dark Realms", 323, Rarity.MYTHIC, mage.cards.r.RiseOfTheDarkRealms.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Rise of the Dark Realms", 387, Rarity.MYTHIC, mage.cards.r.RiseOfTheDarkRealms.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Rite of Replication", 711, Rarity.RARE, mage.cards.r.RiteOfReplication.class));
        cards.add(new SetCardInfo("Rite of the Dragoncaller", 331, Rarity.MYTHIC, mage.cards.r.RiteOfTheDragoncaller.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Rite of the Dragoncaller", 393, Rarity.MYTHIC, mage.cards.r.RiteOfTheDragoncaller.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Rite of the Dragoncaller", 467, Rarity.MYTHIC, mage.cards.r.RiteOfTheDragoncaller.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Rite of the Dragoncaller", 92, Rarity.MYTHIC, mage.cards.r.RiteOfTheDragoncaller.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Rune-Sealed Wall", 49, Rarity.UNCOMMON, mage.cards.r.RuneSealedWall.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Rune-Sealed Wall", 745, Rarity.UNCOMMON, mage.cards.r.RuneSealedWall.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Scrawling Crawler", 132, Rarity.RARE, mage.cards.s.ScrawlingCrawler.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Scrawling Crawler", 354, Rarity.RARE, mage.cards.s.ScrawlingCrawler.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Scrawling Crawler", 415, Rarity.RARE, mage.cards.s.ScrawlingCrawler.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Scrawling Crawler", 486, Rarity.RARE, mage.cards.s.ScrawlingCrawler.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Searslicer Goblin", 332, Rarity.RARE, mage.cards.s.SearslicerGoblin.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Searslicer Goblin", 394, Rarity.RARE, mage.cards.s.SearslicerGoblin.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Searslicer Goblin", 468, Rarity.RARE, mage.cards.s.SearslicerGoblin.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Searslicer Goblin", 93, Rarity.RARE, mage.cards.s.SearslicerGoblin.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Serra Angel", 147, Rarity.UNCOMMON, mage.cards.s.SerraAngel.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Serra Angel", 740, Rarity.UNCOMMON, mage.cards.s.SerraAngel.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Shipwreck Dowser", 596, Rarity.UNCOMMON, mage.cards.s.ShipwreckDowser.class));
        cards.add(new SetCardInfo("Shivan Dragon", 206, Rarity.UNCOMMON, mage.cards.s.ShivanDragon.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Shivan Dragon", 763, Rarity.UNCOMMON, mage.cards.s.ShivanDragon.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Simic Guildgate", 695, Rarity.COMMON, mage.cards.s.SimicGuildgate.class));
        cards.add(new SetCardInfo("Sire of Seven Deaths", 1, Rarity.MYTHIC, mage.cards.s.SireOfSevenDeaths.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Sire of Seven Deaths", 292, Rarity.MYTHIC, mage.cards.s.SireOfSevenDeaths.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Sire of Seven Deaths", 362, Rarity.MYTHIC, mage.cards.s.SireOfSevenDeaths.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Skeleton Archer", 526, Rarity.COMMON, mage.cards.s.SkeletonArcher.class));
        cards.add(new SetCardInfo("Skyknight Squire", 23, Rarity.RARE, mage.cards.s.SkyknightSquire.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Skyknight Squire", 301, Rarity.RARE, mage.cards.s.SkyknightSquire.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Skyknight Squire", 370, Rarity.RARE, mage.cards.s.SkyknightSquire.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Skyknight Squire", 448, Rarity.RARE, mage.cards.s.SkyknightSquire.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Solemn Simulacrum", 257, Rarity.RARE, mage.cards.s.SolemnSimulacrum.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Solemn Simulacrum", 729, Rarity.RARE, mage.cards.s.SolemnSimulacrum.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Soulstone Sanctuary", 133, Rarity.RARE, mage.cards.s.SoulstoneSanctuary.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Soulstone Sanctuary", 356, Rarity.RARE, mage.cards.s.SoulstoneSanctuary.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Soulstone Sanctuary", 416, Rarity.RARE, mage.cards.s.SoulstoneSanctuary.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Spectral Sailor", 164, Rarity.UNCOMMON, mage.cards.s.SpectralSailor.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Spectral Sailor", 746, Rarity.UNCOMMON, mage.cards.s.SpectralSailor.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Sphinx of the Final Word", 597, Rarity.MYTHIC, mage.cards.s.SphinxOfTheFinalWord.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Sphinx of the Final Word", 747, Rarity.MYTHIC, mage.cards.s.SphinxOfTheFinalWord.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Spinner of Souls", 112, Rarity.RARE, mage.cards.s.SpinnerOfSouls.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Spinner of Souls", 341, Rarity.RARE, mage.cards.s.SpinnerOfSouls.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Spinner of Souls", 402, Rarity.RARE, mage.cards.s.SpinnerOfSouls.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Spinner of Souls", 474, Rarity.RARE, mage.cards.s.SpinnerOfSouls.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Spitfire Lagac", 208, Rarity.COMMON, mage.cards.s.SpitfireLagac.class));
        cards.add(new SetCardInfo("Springbloom Druid", 646, Rarity.COMMON, mage.cards.s.SpringbloomDruid.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Springbloom Druid", 767, Rarity.COMMON, mage.cards.s.SpringbloomDruid.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Strix Lookout", 52, Rarity.COMMON, mage.cards.s.StrixLookout.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Strix Lookout", 748, Rarity.COMMON, mage.cards.s.StrixLookout.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Surrak, the Hunt Caller", 647, Rarity.RARE, mage.cards.s.SurrakTheHuntCaller.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Surrak, the Hunt Caller", 768, Rarity.RARE, mage.cards.s.SurrakTheHuntCaller.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Swamp", 286, Rarity.LAND, mage.cards.basiclands.Swamp.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Swamp", 287, Rarity.LAND, mage.cards.basiclands.Swamp.class, FULL_ART_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Sylvan Scavenging", 113, Rarity.RARE, mage.cards.s.SylvanScavenging.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Sylvan Scavenging", 342, Rarity.RARE, mage.cards.s.SylvanScavenging.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Sylvan Scavenging", 403, Rarity.RARE, mage.cards.s.SylvanScavenging.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Sylvan Scavenging", 475, Rarity.RARE, mage.cards.s.SylvanScavenging.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Tempest Djinn", 598, Rarity.RARE, mage.cards.t.TempestDjinn.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Tempest Djinn", 749, Rarity.RARE, mage.cards.t.TempestDjinn.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Terror of Mount Velus", 549, Rarity.RARE, mage.cards.t.TerrorOfMountVelus.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Terror of Mount Velus", 764, Rarity.RARE, mage.cards.t.TerrorOfMountVelus.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Think Twice", 425, Rarity.MYTHIC, mage.cards.t.ThinkTwice.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Think Twice", 435, Rarity.MYTHIC, mage.cards.t.ThinkTwice.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Tinybones, Bauble Burglar", 324, Rarity.RARE, mage.cards.t.TinybonesBaubleBurglar.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Tinybones, Bauble Burglar", 388, Rarity.RARE, mage.cards.t.TinybonesBaubleBurglar.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Tinybones, Bauble Burglar", 463, Rarity.RARE, mage.cards.t.TinybonesBaubleBurglar.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Tinybones, Bauble Burglar", 72, Rarity.RARE, mage.cards.t.TinybonesBaubleBurglar.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Twinflame Tyrant", 333, Rarity.MYTHIC, mage.cards.t.TwinflameTyrant.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Twinflame Tyrant", 395, Rarity.MYTHIC, mage.cards.t.TwinflameTyrant.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Twinflame Tyrant", 427, Rarity.MYTHIC, mage.cards.t.TwinflameTyrant.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Twinflame Tyrant", 437, Rarity.MYTHIC, mage.cards.t.TwinflameTyrant.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Twinflame Tyrant", 469, Rarity.MYTHIC, mage.cards.t.TwinflameTyrant.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Twinflame Tyrant", 97, Rarity.MYTHIC, mage.cards.t.TwinflameTyrant.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Unsummon", 599, Rarity.COMMON, mage.cards.u.Unsummon.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Unsummon", 750, Rarity.COMMON, mage.cards.u.Unsummon.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Untamed Hunger", 529, Rarity.COMMON, mage.cards.u.UntamedHunger.class));
        cards.add(new SetCardInfo("Valkyrie's Call", 27, Rarity.MYTHIC, mage.cards.v.ValkyriesCall.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Valkyrie's Call", 302, Rarity.MYTHIC, mage.cards.v.ValkyriesCall.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Valkyrie's Call", 371, Rarity.MYTHIC, mage.cards.v.ValkyriesCall.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Valkyrie's Call", 449, Rarity.MYTHIC, mage.cards.v.ValkyriesCall.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Vampire Interloper", 530, Rarity.COMMON, mage.cards.v.VampireInterloper.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Vampire Interloper", 756, Rarity.COMMON, mage.cards.v.VampireInterloper.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Vampire Neonate", 531, Rarity.COMMON, mage.cards.v.VampireNeonate.class));
        cards.add(new SetCardInfo("Vampire Nighthawk", 186, Rarity.UNCOMMON, mage.cards.v.VampireNighthawk.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Vampire Nighthawk", 757, Rarity.UNCOMMON, mage.cards.v.VampireNighthawk.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Vampire Soulcaller", 75, Rarity.COMMON, mage.cards.v.VampireSoulcaller.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Vampire Soulcaller", 758, Rarity.COMMON, mage.cards.v.VampireSoulcaller.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Vivien Reid", 234, Rarity.MYTHIC, mage.cards.v.VivienReid.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Vivien Reid", 361, Rarity.MYTHIC, mage.cards.v.VivienReid.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Vivien Reid", 421, Rarity.MYTHIC, mage.cards.v.VivienReid.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Vizier of the Menagerie", 649, Rarity.MYTHIC, mage.cards.v.VizierOfTheMenagerie.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Vizier of the Menagerie", 769, Rarity.MYTHIC, mage.cards.v.VizierOfTheMenagerie.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Zimone, Paradox Sculptor", 126, Rarity.MYTHIC, mage.cards.z.ZimoneParadoxSculptor.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Zimone, Paradox Sculptor", 351, Rarity.MYTHIC, mage.cards.z.ZimoneParadoxSculptor.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Zimone, Paradox Sculptor", 412, Rarity.MYTHIC, mage.cards.z.ZimoneParadoxSculptor.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Zimone, Paradox Sculptor", 483, Rarity.MYTHIC, mage.cards.z.ZimoneParadoxSculptor.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Zombify", 187, Rarity.UNCOMMON, mage.cards.z.Zombify.class));
        cards.add(new SetCardInfo("Zul Ashur, Lich Lord", 326, Rarity.RARE, mage.cards.z.ZulAshurLichLord.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Zul Ashur, Lich Lord", 389, Rarity.RARE, mage.cards.z.ZulAshurLichLord.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Zul Ashur, Lich Lord", 464, Rarity.RARE, mage.cards.z.ZulAshurLichLord.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Zul Ashur, Lich Lord", 77, Rarity.RARE, mage.cards.z.ZulAshurLichLord.class, NON_FULL_USE_VARIOUS));
    }
}
