...
public final class Foundations extends ExpansionSet {
    ...
    private Foundations() {
        ...
        cards.add(new SetCardInfo("Lathril, Blade of the Elves", 242, Rarity.MYTHIC, mage.cards.l.LathrilBladeOfTheElves.class));
        ...
        cards.add(new SetCardInfo("Maalfeld Twins", 523, Rarity.COMMON, mage.cards.m.MaalfeldTwins.class));
        ...
        cards.add(new SetCardInfo("Snakeskin Veil", 233, Rarity.COMMON, mage.cards.s.SnakeskinVeil.class));
