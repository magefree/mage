...
public final class DoctorWho extends ExpansionSet {
    ...
    private DoctorWho() {
        ...
        cards.add(new SetCardInfo("The Foretold Soldier", 102, Rarity.RARE, mage.cards.t.TheForetoldSoldier.class));
        ...
        cards.add(new SetCardInfo("Time Reaper", 71, Rarity.RARE, mage.cards.t.TimeReaper.class));
