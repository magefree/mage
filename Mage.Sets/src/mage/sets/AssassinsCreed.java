...
public final class AssassinsCreed extends ExpansionSet {
    ...
    private AssassinsCreed() {
        ...
        // cards.add(new SetCardInfo("Shaun & Rebecca, Agents", 64, Rarity.RARE, mage.cards.s.ShaunRebeccaAgents.class, NON_FULL_USE_VARIOUS));
        // cards.add(new SetCardInfo("Shaun & Rebecca, Agents", 152, Rarity.RARE, mage.cards.s.ShaunRebeccaAgents.class, NON_FULL_USE_VARIOUS));
        // cards.add(new SetCardInfo("Shaun & Rebecca, Agents", 247, Rarity.RARE, mage.cards.s.ShaunRebeccaAgents.class, NON_FULL_USE_VARIOUS));
