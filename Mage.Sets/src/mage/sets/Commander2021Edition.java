...
public final class Commander2021Edition extends ExpansionSet {
    ...
    private Commander2021Edition() {
        ...
        cards.add(new SetCardInfo("Esix, Fractal Bloom", 10, Rarity.MYTHIC, mage.cards.e.EsixFractalBloom.class));
        ...
        cards.add(new SetCardInfo("Osgir, the Reconstructor", 8, Rarity.MYTHIC, mage.cards.o.OsgirTheReconstructor.class));
        ...
        cards.add(new SetCardInfo("Rionya, Fire Dancer", 55, Rarity.RARE, mage.cards.r.RionyaFireDancer.class));
