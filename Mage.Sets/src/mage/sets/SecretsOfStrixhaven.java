...
public final class SecretsOfStrixhaven extends ExpansionSet {
    ...
    private static final List<String> unfinished = Arrays.asList("Abigale, Poet Laureate", "Adventurous Eater", "Blazing Firesinger", "Campus Composer", "Cheerful Osteomancer", "Decorum Dissertation", "Echocasting Symposium", "Elite Interceptor", "Emeritus of Conflict", "Emeritus of Truce", "Emeritus of Woe", "Encouraging Aviator", "Germination Practicum", "Goblin Glasswright", "Grave Researcher", "Harmonized Trio", "Honorbound Page", "Improvisation Capstone", "Infirmary Healer", "Jadzi, Steward of Fate", "Joined Researchers", "Kirol, History Buff", "Landscape Painter", "Leech Collector", "Lluwen, Exchange Student", "Maelstrom Artisan", "Pigment Wrangler", "Quill-Blade Laureate", "Restoration Seminar", "Sanar, Unfinished Genius", "Scathing Shadelock", "Scheming Silvertongue", "Skycoach Conductor", "Spellbook Seeker", "Spiritcall Enthusiast", "Strife Scholar", "Studious First-Year", "Tam, Observant Sequencer");
    ...
    private SecretsOfStrixhaven() {
        ...
        cards.add(new SetCardInfo("Living History", 121, Rarity.UNCOMMON, mage.cards.l.LivingHistory.class));
        ...
        cards.add(new SetCardInfo("Transcendent Archaic", 5, Rarity.UNCOMMON, mage.cards.t.TranscendentArchaic.class));
