...
public final class LorwynEclipsed extends ExpansionSet {
    ...
    private LorwynEclipsed() {
        ...
        // cards.add(new SetCardInfo("Aurora Awakener", 165, Rarity.MYTHIC, mage.cards.a.AuroraAwakener.class));
        // cards.add(new SetCardInfo("Boggart Mischief", 92, Rarity.UNCOMMON, mage.cards.b.BoggartMischief.class));
        // cards.add(new SetCardInfo("Bre of Clan Stoutarm", 207, Rarity.RARE, mage.cards.b.BreOfClanStoutarm.class));
        ...
        // cards.add(new SetCardInfo("Goliath Daydreamer", 143, Rarity.RARE, mage.cards.g.GoliathDaydreamer.class));
        // cards.add(new SetCardInfo("Grub's Command", 228, Rarity.RARE, mage.cards.g.GrubsCommand.class));
        // cards.add(new SetCardInfo("Harmonized Crescendo", 54, Rarity.RARE, mage.cards.h.HarmonizedCrescendo.class));
        // cards.add(new SetCardInfo("Hexing Squelcher", 145, Rarity.RARE, mage.cards.h.HexingSquelcher.class));
        // cards.add(new SetCardInfo("Iron-Shield Elf", 108, Rarity.UNCOMMON, mage.cards.i.IronShieldElf.class));
        // cards.add(new SetCardInfo("Kinbinding", 20, Rarity.RARE, mage.cards.k.Kinbinding.class));
        // cards.add(new SetCardInfo("Lavaleaper", 150, Rarity.RARE, mage.cards.l.Lavaleaper.class));
        // cards.add(new SetCardInfo("Meek Attack", 151, Rarity.MYTHIC, mage.cards.m.MeekAttack.class));
        // cards.add(new SetCardInfo("Mirrorform", 59, Rarity.MYTHIC, mage.cards.m.Mirrorform.class));
        // cards.add(new SetCardInfo("Mirrormind Crown", 258, Rarity.RARE, mage.cards.m.MirrormindCrown.class));
        // cards.add(new SetCardInfo("Moonglove Extractor", 109, Rarity.COMMON, mage.cards.m.MoongloveExtractor.class));
        // cards.add(new SetCardInfo("Moonsong Aria", 111, Rarity.RARE, mage.cards.m.MoonsongAria.class));
        // cards.add(new SetCardInfo("Oko, Lorwyn Liege", 61, Rarity.MYTHIC, mage.cards.o.OkoLorwynLiege.class));
        // cards.add(new SetCardInfo("Personify", 28, Rarity.UNCOMMON, mage.cards.p.Personify.class));
        // cards.add(new SetCardInfo("Rhys, the Evermore", 32, Rarity.RARE, mage.cards.r.RhyTheEvermore.class));
        // cards.add(new SetCardInfo("Sanar, Innovative First-Year", 241, Rarity.RARE, mage.cards.s.SanarInnovativeFirstYear.class));
        // cards.add(new SetCardInfo("Sear", 154, Rarity.UNCOMMON, mage.cards.s.Sear.class));
        // cards.add(new SetCardInfo("Selfless Safewright", 193, Rarity.RARE, mage.cards.s.SelflessSafewright.class));
        ...
        // cards.add(new SetCardInfo("Thoughtweft Lieutenant", 246, Rarity.UNCOMMON, mage.cards.t.ThoughtweftLieutenant.class));
