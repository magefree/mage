...
public final class InnistradCrimsonVow extends ExpansionSet {
    ...
    private InnistradCrimsonVow() {
        ...
        cards.add(new SetCardInfo("Bloodbat Summoner", 137, Rarity.RARE, mage.cards.b.BloodbatSummoner.class));
        ...
        cards.add(new SetCardInfo("Cemetery Illuminator", 50, Rarity.MYTHIC, mage.cards.c.CemeteryIlluminator.class));
        ...
        cards.add(new SetCardInfo("Creepy Puppeteer", 151, Rarity.RARE, mage.cards.c.CreepyPuppeteer.class));
        ...
        cards.add(new SetCardInfo("Dollhouse of Horrors", 255, Rarity.RARE, mage.cards.d.DollhouseOfHorrors.class));
