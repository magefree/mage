...
public class ShadowsOverInnistradRemastered extends ExpansionSet {
    ...
    private ShadowsOverInnistradRemastered() {
        ...
        cards.add(new SetCardInfo("Bruna, the Fading Light", "17", "17b", Rarity.RARE, mage.cards.b.BrunaTheFadingLight.class));
        ...
        cards.add(new SetCardInfo("Gisela, the Broken Blade", "30", "17b", Rarity.MYTHIC, mage.cards.g.GiselaTheBrokenBlade.class));
        ...
        cards.add(new SetCardInfo("Graf Rats", "115", "115b", Rarity.COMMON, mage.cards.g.GrafRats.class));
        ...
        cards.add(new SetCardInfo("Hanweir Battlements", "271", "161b", Rarity.RARE, mage.cards.h.HanweirBattlements.class));
        cards.add(new SetCardInfo("Hanweir Garrison", "161", "161b", Rarity.RARE, mage.cards.h.HanweirGarrison.class));
        ...
        cards.add(new SetCardInfo("Midnight Scavengers", "123", "115b", Rarity.UNCOMMON, mage.cards.m.MidnightScavengers.class));
