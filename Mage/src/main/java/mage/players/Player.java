...
public interface Player extends MageItem, Copyable<Player> {
    ...
    boolean choose(Outcome outcome, Target target, UUID sourceId, Ability source, Game game);

    boolean choose(Outcome outcome, Target target, UUID sourceId, Ability source, Game game, Map<String, Serializable> options);
