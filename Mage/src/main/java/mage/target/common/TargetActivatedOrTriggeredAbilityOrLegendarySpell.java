...
public class TargetActivatedOrTriggeredAbilityOrLegendarySpell extends TargetObject {
    ...
    public boolean canTarget(UUID id, Ability source, Game game) {
        ...
        return isActivatedOrTriggeredAbilityOrLegendarySpell(stackObject) && source != null && filter.match(stackObject, source.getSourceId(), source.getControllerId(), source, game);
    }
