...
public enum CardRepository {
    ...
    public Set<String> getNames() {
        ...
        try {
            ...
            qb.distinct().selectColumns("name", "modalDoubleFacedSecondSideName", "secondSideName", "flipCardName", "singleFaceSplitCardSpellName");
            ...
            if (name.contains(" // ")) { //
                ...
                if (results.isEmpty()) {
                    ...
                    queryBuilder.where()
                            ...
                            .eq("singleFaceSplitCardSpellName", new SelectArg(name)).or()
