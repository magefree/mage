...
public class EmergeAbility extends SpellAbility {
        ...
        if (super.canActivate(playerId, game).canActivate()) {
            ...
            if (controller != null) {
                for (Permanent creature : game.getBattlefield().getActivePermanents(
                        new FilterControlledCreaturePermanent(), this.getControllerId(), this.getSourceId(), this, game)) {
    ...
    public ManaOptions getMinimumCostToActivate(UUID playerId, Game game) {
        int maxCMC = 0;
        for (Permanent creature : game.getBattlefield().getActivePermanents(new FilterControlledCreaturePermanent(), playerId, this.getSourceId(), this, game)) {
    ...
    public boolean activate(Game game, boolean noMana) {
        ...
        if (controller != null) {
            ...
            if (controller.choose(Outcome.Sacrifice, target, this.getSourceId(), this, game)) {
