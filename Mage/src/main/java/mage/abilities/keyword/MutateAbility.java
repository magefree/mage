...
public class MutateAbility extends SpellAbility {
    ...
    protected Costs<Cost> mutateCosts;
    ...
    public MutateAbility(Card card, String mutateCosts, Zone zone) {
        super(new ManaCostsImpl<>(mutateCosts), card.getName() + " using mutate");
        this.zone = zone;
        this.spellAbilityType = SpellAbilityType.BASE_ALTERNATE;
        this.spellAbilityCastMode = SpellAbilityCastMode.MUTATE;
        this.timing = TimingRule.SORCERY;
        TargetCreaturePermanent mutateTarget = new TargetCreaturePermanent(filter);
