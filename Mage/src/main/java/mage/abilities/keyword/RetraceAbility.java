...
import mage.abilities.costs.MandatoryAdditionalSourceCosts;
...
class RetraceSpellAbility extends SpellAbility implements MandatoryAdditionalSourceCosts {
    ...
    @Override
    public void addMandatoryAdditionalCosts(Ability ability, Game game) {
