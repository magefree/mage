...
public class PutCardFromHandOnTopOfLibraryCost extends CostImpl {
    ...
    public boolean pay(Ability ability, Game game, Ability source, UUID controllerId, boolean noMana, Cost costToPay) {
        ...
        Card card;
        if (targetCardInHand.canChoose(source.getSourceId(), controllerId, source, game)
                && controller.choose(Outcome.PreventDamage, targetCardInHand, source.getSourceId(), source, game)) {
