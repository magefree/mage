...
public class DiscardCardYouChooseTargetEffect extends OneShotEffect {
    ...
    public boolean apply(Game game, Ability source) {
        ...
        if (player.getHand().size() > numberToReveal) {
            ...
            if (chosenCards.canChoose(source.getSourceId(), player.getId(), source, game)
        ...
        boolean result = true;
        int filteredCardsCount = revealedCards.count(filter, source.getSourceId(), source.getControllerId(), source, game);
