            ...
            if (card != null) {
                ...
                if (card.isLand(game)) {
                    ...
                    if (morphAbility) {
                        ...
                        return filter.match(cardCopy, source.getSourceId(), affectedControllerId, source, game);
                    }
                }
                return filter.match(card, source.getSourceId(), affectedControllerId, source, game);
            }
        }
        return false;
    }
